...
struct BinaryMathOperation : BaseVisitor<>
{
    ...
    template<typename CharT>
    InternalValue operator() (const std::basic_string_view<CharT> &left, const std::basic_string<CharT> &right) const
    {
        return ProcessStrings(left, std::basic_string_view<CharT>(right));
    }

    template<typename CharT1, typename CharT2>
    std::enable_if_t<!std::is_same<CharT1, CharT2>::value, InternalValue> operator() (const std::basic_string_view<CharT1>& left, const std::basic_string<CharT2>& right) const
    {
        auto rightStr = ConvertString<std::basic_string<CharT1>>(right);
    ...
    template<typename CharT>
    InternalValue operator() (const std::basic_string<CharT> &left, const std::basic_string_view<CharT> &right) const
    {
        return ProcessStrings(std::basic_string_view<CharT>(left), right);
    }

    template<typename CharT1, typename CharT2>
    std::enable_if_t<!std::is_same<CharT1, CharT2>::value, InternalValue> operator() (const std::basic_string<CharT1>& left, const std::basic_string_view<CharT2>& right) const
    {
        auto rightStr = ConvertString<std::basic_string<CharT1>>(right);
        return ProcessStrings(std::basic_string_view<CharT1>(left), std::basic_string_view<CharT1>(rightStr));
    }
    ...
    template<typename CharT>
    InternalValue operator() (const std::basic_string_view<CharT> &left, const std::basic_string_view<CharT> &right) const
    {
        return ProcessStrings(left, right);
    }

    template<typename CharT1, typename CharT2>
    std::enable_if_t<!std::is_same<CharT1, CharT2>::value, InternalValue> operator() (const std::basic_string_view<CharT1>& left, const std::basic_string_view<CharT2>& right) const
    {
        auto rightStr = ConvertString<std::basic_string<CharT1>>(right);
        return ProcessStrings(left, std::basic_string_view<CharT1>(rightStr));
    }
    ...
    template<typename CharT>
    InternalValue operator() (const std::basic_string_view<CharT> &left, int64_t right) const
    {
        return RepeatString(left, right);
    }

    template<typename CharT>
    InternalValue RepeatString(const std::basic_string_view<CharT>& left, const int64_t right) const
    {
    ...
    template<typename CharT>
    InternalValue ProcessStrings(const std::basic_string_view<CharT>& left, const std::basic_string_view<CharT>& right) const
    {
        using string = std::basic_string<CharT>;
        InternalValue result;
