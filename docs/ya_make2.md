...
- [Контентные (динамические) UIDы](#Контентные-(динамические)-UIDы)
...
Локальная сборка работает в режиме [контетных UIDов](https://github.com/mtv2000/yatool/blob/newstyle/docs/UIDwork.md#Сборка-с-контентными-UID-ами)
