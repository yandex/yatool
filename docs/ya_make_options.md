...
Это означает удаление всех промежуточных и итоговых файлов, созданных во время прошлых процессов сборки, чтобы исключить влияние устаревших или некорректных данных на новую сборку.

В результате использования опции  `--rebuild` гарантируется, что все составные части проекта будут скомпилированы заново, что способствует исключению ошибок, связанных с конфликтами или несогласованностями в файлах, и обеспечивает точное соответствие текущего состояния исходного кода скомпилированным компонентам.
