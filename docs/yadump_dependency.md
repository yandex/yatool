...
С помощью различных опций (`--ignore-recurses`, `--no-tools` и т.д.) можно детализировать граф зависимостей.
3. Отображение путей зависимости для модуля или проекта:
Позволяет получить список путей зависимостей для проекта или модуля в директории. 
