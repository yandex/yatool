...
Это сделает ваш тип проекта **по умолчанию** в этой директории и для его обновляния можно будет вызывать `ya project update` без явного указания типа проекта.

#### Финальные штрихи

После генерации будет вызвана функция `postprocess`. В ней можно внести финальные штрихи в сегенрированный проект или вывести сообщение.
