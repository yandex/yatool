...
При сборке такого ya.make будут собраны все указанные цели и их вложенные зависимости. Система сборки поддерживает различные языки и модули для разнообразных задач.
...
- В ya.make проекта запрещено менять глобальные флаги.
...
Сборка Python в ya.make включает в себя предкомпиляцию зависимых пакетов и модулей, генерацию бинарных C/C++ модулей через Cython и запуск интерпретатора Python.
...
Система сборки ya.make предоставляет большое количество макросов для различных языков и применений. Они описаны в соответствующих разделах:
