...
Основная задача `ya package` - предоставление возможности хранения полной конфигурации сборки пакета в репозитории и его воспроизводимой сборки. 

Команда пакетирования позволяет собирать различные типы пакетов, описанных в специальных JSON-файлах, и публиковать в различных фиксированных конфигурациях.
