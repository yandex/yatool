...
## Table of contents
   ...
   * [Multimodules](#multimodules)
       ...
       - Multimodule [ROS_LIBRARY](#multimodule_ROS_LIBRARY)
       - Multimodule [SANDBOX_PY23_3_TASK](#multimodule_SANDBOX_PY23_3_TASK)
   ...
   * [Modules](#modules)
       ...
       - Module [ESP_BOOTLOADER](#module_ESP_BOOTLOADER)
       - Module [ESP_LIBRARY](#module_ESP_LIBRARY)
       - Module [ESP_PROGRAM](#module_ESP_PROGRAM)
       ...
       - Module [MAPS_IDL_JSRC_LIBRARY](#module_MAPS_IDL_JSRC_LIBRARY)
   ...
   * [Macros](#macros)
       ...
       - Macros [ADD_COMPILABLE_TRANSLIT](#macro_ADD_COMPILABLE_TRANSLIT) .. [ALL_PYTEST_SRCS](#macro_ALL_PYTEST_SRCS)
       - Macros [ALL_PY_SRCS](#macro_ALL_PY_SRCS) .. [ARCHIVE_BY_KEYS](#macro_ARCHIVE_BY_KEYS)
       - Macros [ASM_PREINCLUDE](#macro_ASM_PREINCLUDE) .. [BPF](#macro_BPF)
       ...
       - Macros [CLEAN_TEXTREL](#macro_CLEAN_TEXTREL) .. [COMPILE_NLG](#macro_COMPILE_NLG)
       - Macros [COMPILE_SWIFT_MODULE](#macro_COMPILE_SWIFT_MODULE) .. [CPP_PROTOLIBS_DEBUG_INFO](#macro_CPP_PROTOLIBS_DEBUG_INFO)
       ...
       - Macros [DIRECT_DEPS_ONLY](#macro_DIRECT_DEPS_ONLY) .. [DUMPERF_CODEGEN](#macro_DUMPERF_CODEGEN)
       - Macros [DYNAMIC_LIBRARY_FROM](#macro_DYNAMIC_LIBRARY_FROM) .. [ESP_KCONFIG](#macro_ESP_KCONFIG)
       - Macros [ESP_KCONFIG_PROJBUILD](#macro_ESP_KCONFIG_PROJBUILD) .. [EXPORT_ALL_DYNAMIC_SYMBOLS](#macro_EXPORT_ALL_DYNAMIC_SYMBOLS)
       - Macros [EXPORT_YMAPS_PROTO](#macro_EXPORT_YMAPS_PROTO) .. [FLATC_FLAGS](#macro_FLATC_FLAGS)
       - Macros [FLAT_JOIN_SRCS_GLOBAL](#macro_FLAT_JOIN_SRCS_GLOBAL) .. [FROM_MDS](#macro_FROM_MDS)
       - Macros [FROM_SANDBOX](#macro_FROM_SANDBOX) .. [GENERATE_YT_RECORD](#macro_GENERATE_YT_RECORD)
       ...
       - Macros [GO_LINK_FLAGS](#macro_GO_LINK_FLAGS) .. [GO_SKIP_TESTS](#macro_GO_SKIP_TESTS)
       ...
       - Macros [NO_PROFILE_RUNTIME](#macro_NO_PROFILE_RUNTIME) .. [NO_WERROR](#macro_NO_WERROR)
       ...
       - Macros [REGISTER_SANDBOX_IMPORT](#macro_REGISTER_SANDBOX_IMPORT) .. [ROS_DIR](#macro_ROS_DIR)
       ...
       - Macros [SRC_C_PIC](#macro_SRC_C_PIC) .. [STRUCT_CODEGEN](#macro_STRUCT_CODEGEN)
       - Macros [STYLE](#macro_STYLE) .. [TASKLET](#macro_TASKLET)
       - Macros [TASKLET_REG](#macro_TASKLET_REG) .. [TS_ESLINT_CONFIG](#macro_TS_ESLINT_CONFIG)
       - Macros [TS_EXCLUDE_FILES_GLOB](#macro_TS_EXCLUDE_FILES_GLOB) .. [TS_TYPECHECK](#macro_TS_TYPECHECK)
       - Macros [TS_VITE_CONFIG](#macro_TS_VITE_CONFIG) .. [UBERJAR_MANIFEST_TRANSFORMER_MAIN](#macro_UBERJAR_MANIFEST_TRANSFORMER_MAIN)
       - Macros [UBERJAR_PATH_EXCLUDE_PREFIX](#macro_UBERJAR_PATH_EXCLUDE_PREFIX) .. [USE_JAVALITE](#macro_USE_JAVALITE)
       - Macros [USE_KTLINT_OLD](#macro_USE_KTLINT_OLD) .. [USE_PERL_LIB](#macro_USE_PERL_LIB)
       - Macros [USE_PLANTUML](#macro_USE_PLANTUML) .. [USRV_GEN_GRPC_CLIENT](#macro_USRV_GEN_GRPC_CLIENT)
       - Macros [USRV_GEN_GRPC_SERVICE](#macro_USRV_GEN_GRPC_SERVICE) .. [WINDOWS_LONG_PATH_MANIFEST](#macro_WINDOWS_LONG_PATH_MANIFEST)
       - Macros [WINDOWS_MANIFEST](#macro_WINDOWS_MANIFEST) .. [WITH_KOTLINC_NOARG](#macro_WITH_KOTLINC_NOARG)
       - Macros [WITH_KOTLINC_SERIALIZATION](#macro_WITH_KOTLINC_SERIALIZATION) .. [YMAPS_SPROTO](#macro_YMAPS_SPROTO)
...
###### Multimodule [ROS\_LIBRARY][] <a name="multimodule_ROS_LIBRARY"></a>
Not documented yet.

###### Multimodule [SANDBOX\_PY23\_3\_TASK][]([Name]) <a name="multimodule_SANDBOX_PY23_3_TASK"></a>
...
It may PEERDIR other SANDBOX\_PY3\_TASK/SANDBOX\_PY23\_3\_TASK as libraries.
The final artifact is provided when SANDBOX\_PY23\_3\_TASK is referred to by DEPENDS and BUNDLE macros.
As PEERDIR target, it works like regular PY23\_LIBRARY with predefined dependencies on Sandbox SDK.
...
###### Multimodule [SANDBOX\_PY23\_TASK][]([Name]) <a name="multimodule_SANDBOX_PY23_TASK"></a>
Multimodule describing Sandbox task - code that can be executed by Sandbox system.

When being a final target, this multimodule builds Python 2.x Sandbox binary task.
It may PEERDIR other SANDBOX\_PY23\_TASKs as libraries.
The final artifact is provided when SANDBOX\_PY23\_TASK is referred to by DEPENDS and BUNDLE macros.
As PEERDIR target, it works like regular PY23\_LIBRARY with predefined dependencies on Sandbox SDK.
...
As PEERDIR target, it works like regular PY3\_LIBRARY with predefined dependencies on Sandbox SDK.
...
###### Multimodule [SANDBOX\_TASK][]([Name]) _# deprecated_ <a name="multimodule_SANDBOX_TASK"></a>
Deprecated. Use SANDBOX\_PY23\_TASK, SANDBOX\_PY3\_TASK or SANDBOX\_PY23\_3\_TASK instead.

When being a final target, this multimodule builds Python 2.x Sandbox binary task.
It may PEERDIR other SANDBOX\_TASKs as libraries.
The final artifact is provided when SANDBOX\_TASK is referred to by DEPENDS and BUNDLE macros.
As PEERDIR target, it works like regular PY2\_LIBRARY with predefined dependencies on Sandbox SDK.

Documentation: https://docs.yandex-team.ru/sandbox/dev/binary-task

###### Multimodule [TS\_NEXT][]() <a name="multimodule_TS_NEXT"></a>
...
###### Module [ESP\_BOOTLOADER][]: PROGRAM <a name="module_ESP_BOOTLOADER"></a>
Not documented yet.

###### Module [ESP\_LIBRARY][]: LIBRARY <a name="module_ESP_LIBRARY"></a>
Not documented yet.

###### Module [ESP\_PROGRAM][]([progname]) <a name="module_ESP_PROGRAM"></a>
...
###### Module [MAPS\_IDL\_JSRC\_LIBRARY][] <a name="module_MAPS_IDL_JSRC_LIBRARY"></a>
...
###### Macro [ALICE\_CAPABILITY][]() <a name="macro_ALICE_CAPABILITY"></a>
Not documented yet.
...
Available allocators are: "LF", "LF\_YT", "LF\_DBG", "YT", "J", "B", "BM", "C", "TCMALLOC", "GOOGLE", "LOCKLESS", "SYSTEM", "FAKE", "MIM", "HU", "PROFILED\_HU", "THREAD\_PROFILED\_HU".
...
###### Macro [APPHOST\_LUA\_LIBS][]([Dir...]) <a name="macro_APPHOST_LUA_LIBS"></a>
Add external lib dirs to LUA\_PATH and include them in DATA
Format for dir: path to dir, eg. apphost/test/general\_apphost
...
###### Macro [COMPILE\_NLG][](NLG\_CONFIG nlg\_config.json, [TRANSLATIONS\_JSON translations.json], [PROTO\_REGISTRY proto\_registry.desc], Files...) <a name="macro_COMPILE_NLG"></a>
...
###### Macro [ESP\_KCONFIG][](Kconfig) <a name="macro_ESP_KCONFIG"></a>
Not documented yet.

###### Macro [ESP\_KCONFIG\_PROJBUILD][](Kconfig) <a name="macro_ESP_KCONFIG_PROJBUILD"></a>
Not documented yet.

###### Macro [ESP\_LDFRAGMENTS][](Fragments...) <a name="macro_ESP_LDFRAGMENTS"></a>
Not documented yet.

###### Macro [ESP\_SDKCONFIG\_RENAME][](Rename) <a name="macro_ESP_SDKCONFIG_RENAME"></a>
Not documented yet.
...
###### Macro [FROM\_HTTPS][](URI) <a name="macro_FROM_HTTPS"></a>
Not documented yet.
...
###### Macro [ROS\_CMD][](SRC) <a name="macro_ROS_CMD"></a>
Not documented yet.

###### Macro [ROS\_DIR][](Dir) <a name="macro_ROS_DIR"></a>
Not documented yet.
...
###### Macro [SET\_LIST\_PRE\_SUF][](OUT, PRE, SUF, IN...) <a name="macro_SET_LIST_PRE_SUF"></a>
Not documented yet.
...
###### Macro [TS\_TYPECHECK][](TS\_CONFG="") <a name="macro_TS_TYPECHECK"></a>
Not documented yet.
...
###### Macro [USRV\_ALL\_SRCS][]([RECURSIVE] [Dirs...] [EXCLUDE <globs...>]) <a name="macro_USRV_ALL_SRCS"></a>
...
###### Macro [USRV\_BUILD][](FROM="Please specify generated .tar-file as FROM", DEPS\_FILE="NO\_DEPS", OUT\_NOAUTO[], Files...) <a name="macro_USRV_BUILD"></a>
Not documented yet.

###### Macro [USRV\_GEN\_GRPC\_CLIENT][](FROM="", Files...) <a name="macro_USRV_GEN_GRPC_CLIENT"></a>
Not documented yet.

###### Macro [USRV\_GEN\_GRPC\_SERVICE][](FROM="", Files...) <a name="macro_USRV_GEN_GRPC_SERVICE"></a>
Not documented yet.
...
Documentation: https://wiki.yandex-team.ru/yatool/test/
 ...
 [DLL\_JAVA]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/swig.conf?rev=14070824#L82
 [DOCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/docs.conf?rev=14070824#L151
 [FBS\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/fbs.conf?rev=14070824#L103
 [JAVA\_CONTRIB\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L244
 [JAVA\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L31
 [JTEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L153
 [JTEST\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L207
 [JUNIT5]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L97
 [MAPS\_IDL\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/maps/mapkit.conf?rev=14070824#L91
 [MKDOCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/docs.conf?rev=14070824#L57
 [PACKAGE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2378
 [PROTO\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L665
 [PY23\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L1006
 [PY23\_NATIVE\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L1033
 [PY23\_TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L1058
 [PY3TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L354
 [PY3\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L218
 [ROS\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/ros.conf?rev=14070824#L19
 [SANDBOX\_PY23\_3\_TASK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/sandbox.conf?rev=14070824#L50
 [SANDBOX\_PY23\_TASK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/sandbox.conf?rev=14070824#L93
 [SANDBOX\_PY3\_TASK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/sandbox.conf?rev=14070824#L133
 [SANDBOX\_TASK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/sandbox.conf?rev=14070824#L12
 [TS\_NEXT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_next.conf?rev=14070824#L46
 [TS\_PACKAGE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_package.conf?rev=14070824#L27
 [TS\_TSC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_tsc.conf?rev=14070824#L20
 [TS\_VITE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_vite.conf?rev=14070824#L52
 [TS\_WEBPACK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_webpack.conf?rev=14070824#L50
 [YQL\_UDF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L184
 [YQL\_UDF\_CONTRIB]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L226
 [YQL\_UDF\_YDB]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L205
 [BOOSTTEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1442
 [BOOSTTEST\_WITH\_MAIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1463
 [CI\_GROUP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2420
 [CONTAINER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/misc.conf?rev=14070824#L17
 [CONTAINER\_LAYER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/misc.conf?rev=14070824#L7
 [CPP\_STYLE\_TEST\_16]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1654
 [CUSTOM\_BUILD\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/misc.conf?rev=14070824#L31
 [DEFAULT\_IOS\_INTERFACE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5566
 [DLL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2187
 [DLL\_TOOL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2204
 [DOCS\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/docs.conf?rev=14070824#L84
 [ESP\_BOOTLOADER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/smart_devices.conf?rev=14070824#L128
 [ESP\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/smart_devices.conf?rev=14070824#L30
 [ESP\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/smart_devices.conf?rev=14070824#L116
 [EXECTEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1690
 [FAT\_OBJECT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2002
 [FUZZ]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1398
 [GEN\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L579
 [GO\_DLL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L932
 [GO\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L811
 [GO\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L828
 [GO\_TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L952
 [GTEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1374
 [G\_BENCHMARK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1726
 [IOS\_INTERFACE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5555
 [JAVA\_CONTRIB]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L552
 [JAVA\_CONTRIB\_PROXY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L503
 [JAVA\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L19
 [LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1865
 [MAPS\_IDL\_JSRC\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/maps/mapkit.conf?rev=14070824#L72
 [MCU\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/smart_devices.conf?rev=14070824#L148
 [PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1231
 [PROTO\_DESCRIPTIONS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L824
 [PROTO\_REGISTRY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L836
 [PY2MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L440
 [PY2TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L304
 [PY2\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L531
 [PY2\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L186
 [PY3MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L459
 [PY3TEST\_BIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L326
 [PY3\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L572
 [PY3\_PROGRAM\_BIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L735
 [PYTEST\_BIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L287
 [PY\_ANY\_MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L382
 [RECURSIVE\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2053
 [RESOURCES\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1948
 [R\_MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2157
 [SO\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2216
 [TS\_TEST\_HERMIONE\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_test.conf?rev=14070824#L62
 [TS\_TEST\_JEST\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_test.conf?rev=14070824#L29
 [TS\_TEST\_PLAYWRIGHT\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_test.conf?rev=14070824#L94
 [UNION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2442
 [UNITTEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1319
 [UNITTEST\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1770
 [UNITTEST\_WITH\_CUSTOM\_ENTRY\_POINT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1355
 [YQL\_PYTHON3\_UDF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L323
 [YQL\_PYTHON3\_UDF\_TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L372
 [YQL\_PYTHON\_UDF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L270
 [YQL\_PYTHON\_UDF\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L297
 [YQL\_PYTHON\_UDF\_TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L358
 [YQL\_UDF\_MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L151
 [YQL\_UDF\_MODULE\_CONTRIB]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L163
 [YQL\_UDF\_TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L36
 [YQL\_UDF\_TEST\_CONTRIB]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L65
 [YQL\_UDF\_YDB\_MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L157
 [YQL\_UDF\_YDB\_TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L53
 [YT\_UNITTEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1345
 [Y\_BENCHMARK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1708
 [AARS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/maps/aar.conf?rev=14070824#L20
 [AAR\_GRADLE\_SCRIPT\_GENERATOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/maps/aar.conf?rev=14070824#L255
 [AAR\_LOCAL\_MAVEN\_REPO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/maps/aar.conf?rev=14070824#L249
 [ACCELEO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L9
 [ADDINCL]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [ADDINCLSELF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2957
 [ADD\_CHECK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L849
 [ADD\_CHECK\_PY\_IMPORTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L891
 [ADD\_CLANG\_TIDY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1130
 [ADD\_COMPILABLE\_TRANSLATE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2625
 [ADD\_COMPILABLE\_TRANSLIT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2635
 [ADD\_DLLS\_TO\_JAR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1696
 [ADD\_LINTER\_CHECK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5798
 [ADD\_PERL\_MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/perl.conf?rev=14070824#L103
 [ADD\_PYTEST\_BIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L934
 [ADD\_YTEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L2279
 [ALICE\_CAPABILITY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/alice.conf?rev=14070824#L45
 [ALLOCATOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2527
 [ALLOCATOR\_IMPL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/opensource.conf?rev=14070824#L89
 [ALL\_PYTEST\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L983
 [ALL\_PY\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L965
 [ALL\_RESOURCE\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2696
 [ALL\_RESOURCE\_FILES\_FROM\_DIRS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2711
 [ALL\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2332
 [ANNOTATION\_PROCESSOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1642
 [APPHOST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/apphost.conf?rev=14070824#L6
 [APPHOST\_LUA\_LIBS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/apphost.conf?rev=14070824#L19
 [ARCHIVE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3904
 [ARCHIVE\_ASM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3882
 [ARCHIVE\_BY\_KEYS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3915
 [ASM\_PREINCLUDE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4929
 [ASSERT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/macros_with_error.py?rev=14070824#L28
 [BASE\_CODEGEN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/codegen.conf?rev=14070824#L4
 [BENCHMARK\_OPTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1745
 [BISON\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L54
 [BISON\_GEN\_C]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L61
 [BISON\_GEN\_CPP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L69
 [BISON\_HEADER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L91
 [BISON\_NO\_HEADER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L101
 [BPF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4739
 [BPF\_STATIC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4753
 [BUILDWITH\_CYTHON\_C]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3788
 [BUILDWITH\_CYTHON\_CPP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3757
 [BUILDWITH\_RAGEL6]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3826
 [BUILD\_CATBOOST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/other.conf?rev=14070824#L9
 [BUILD\_MN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/matrixnet.conf?rev=14070824#L11
 [BUILD\_MNS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/matrixnet.conf?rev=14070824#L36
 [BUILD\_ONLY\_IF]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [BUILD\_YDL\_DESC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3486
 [BUNDLE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/bundle.py?rev=14070824#L4
 [CFLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4021
 [CGO\_CFLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L338
 [CGO\_LDFLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L347
 [CGO\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L321
 [CHECK\_ALLOWED\_PATH]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/plugins/container_layers.py?rev=14070824#L4
 [CHECK\_CONTRIB\_CREDITS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/credits.py?rev=14070824#L9
 [CHECK\_DEPENDENT\_DIRS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L475
 [CHECK\_JAVA\_DEPS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1423
 [CLANG\_EMIT\_AST\_CXX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4702
 [CLANG\_EMIT\_AST\_CXX\_RUN\_TOOL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5842
 [CLEAN\_TEXTREL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2072
 [CMAKE\_EXPORTED\_TARGET\_NAME]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/opensource.conf?rev=14070824#L84
 [COLLECT\_FRONTEND\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5603
 [COLLECT\_GO\_SWAGGER\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L5
 [COLLECT\_JINJA\_TEMPLATES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5133
 [COMPILE\_C\_AS\_CXX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4665
 [COMPILE\_LUA]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3410
 [COMPILE\_LUA\_21]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3428
 [COMPILE\_LUA\_OPENRESTY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3446
 [COMPILE\_NLG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/alice.conf?rev=14070824#L7
 [COMPILE\_SWIFT\_MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5611
 [CONFIGURE\_FILE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4000
 [CONFTEST\_LOAD\_POLICY\_LOCAL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1599
 [CONLYFLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4044
 [COPY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/cp.py?rev=14070824#L6
 [COPY\_FILE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2669
 [COPY\_FILE\_WITH\_CONTEXT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2678
 [CPP\_ADDINCL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4993
 [CPP\_ENUMS\_SERIALIZATION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/pybuild.py?rev=14070824#L817
 [CPP\_PROTOLIBS\_DEBUG\_INFO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L71
 [CPP\_PROTO\_PLUGIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L241
 [CPP\_PROTO\_PLUGIN0]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L227
 [CPP\_PROTO\_PLUGIN2]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L252
 [CREATE\_BUILDINFO\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3971
 [CREATE\_INIT\_PY\_STRUCTURE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/create_init_py.py?rev=14070824#L4
 [CREDITS\_DISCLAIMER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/credits.py?rev=14070824#L4
 [CTEMPLATE\_VARNAMES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4681
 [CUDA\_NVCC\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4058
 [CUSTOM\_CONTRIB\_TYPESCRIPT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/node_modules.conf?rev=14070824#L8
 [CUSTOM\_LINK\_STEP\_SCRIPT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1279
 [CXXFLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4051
 [CYTHON\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4074
 [DARWIN\_SIGNED\_RESOURCE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5546
 [DARWIN\_STRINGS\_RESOURCE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5542
 [DATA]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1538
 [DATA\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1550
 [DEB\_VERSION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4299
 [DECIMAL\_MD5\_LOWER\_32\_BITS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3983
 [DECLARE\_EXTERNAL\_HOST\_RESOURCES\_BUNDLE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [DECLARE\_EXTERNAL\_HOST\_RESOURCES\_BUNDLE\_BY\_JSON]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [DECLARE\_EXTERNAL\_HOST\_RESOURCES\_PACK]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [DECLARE\_EXTERNAL\_RESOURCE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [DECLARE\_EXTERNAL\_RESOURCE\_BY\_JSON]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [DECLARE\_IN\_DIRS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4509
 [DEFAULT]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [DEFAULT\_JAVA\_SRCS\_LAYOUT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L379
 [DEFAULT\_JDK\_VERSION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L2011
 [DEFAULT\_JUNIT\_JAVA\_SRCS\_LAYOUT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L391
 [DEPENDENCY\_MANAGEMENT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1733
 [DEPENDS]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [DIRECT\_DEPS\_ONLY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1885
 [DISABLE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [DISABLE\_DATA\_VALIDATION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1523
 [DLL\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [DOCS\_CONFIG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/docs.conf?rev=14070824#L285
 [DOCS\_COPY\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/docs.conf?rev=14070824#L13
 [DOCS\_DIR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/docs.conf?rev=14070824#L241
 [DOCS\_INCLUDE\_SOURCES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/docs.conf?rev=14070824#L309
 [DOCS\_VARS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/docs.conf?rev=14070824#L297
 [DUMPERF\_CODEGEN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/codegen.conf?rev=14070824#L34
 [DYNAMIC\_LIBRARY\_FROM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2174
 [ELSE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [ELSEIF]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [EMBED\_JAVA\_VCS\_INFO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L276
 [ENABLE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [ENABLE\_PREVIEW]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1604
 [END]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [ENDIF]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [ENV]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1592
 [ESP\_KCONFIG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/smart_devices.conf?rev=14070824#L6
 [ESP\_KCONFIG\_PROJBUILD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/smart_devices.conf?rev=14070824#L11
 [ESP\_LDFRAGMENTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/smart_devices.conf?rev=14070824#L16
 [ESP\_SDKCONFIG\_RENAME]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/smart_devices.conf?rev=14070824#L21
 [EVLOG\_CMD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L840
 [EXCLUDE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1650
 [EXCLUDE\_TAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [EXPLICIT\_DATA]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1560
 [EXPLICIT\_OUTPUTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4840
 [EXPORTS\_SCRIPT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1247
 [EXPORT\_ALL\_DYNAMIC\_SYMBOLS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1261
 [EXPORT\_YMAPS\_PROTO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/maps/sproto.conf?rev=14070824#L4
 [EXTERNAL\_JAR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/java.py?rev=14070824#L280
 [EXTERNAL\_RESOURCE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [EXTRADIR]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [EXTRALIBS\_STATIC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2618
 [FBS\_CMD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/fbs.conf?rev=14070824#L142
 [FBS\_NAMESPACE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/fbs.conf?rev=14070824#L85
 [FBS\_TO\_PY2SRC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/fbs.conf?rev=14070824#L28
 [FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/files.py?rev=14070824#L1
 [FLATC\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/fbs.conf?rev=14070824#L10
 [FLAT\_JOIN\_SRCS\_GLOBAL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2834
 [FLEX\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L47
 [FLEX\_GEN\_C]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L77
 [FLEX\_GEN\_CPP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L84
 [FORK\_SUBTESTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2766
 [FORK\_TESTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2752
 [FORK\_TEST\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2792
 [FROM\_ARCHIVE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4650
 [FROM\_HTTPS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/experiments.conf?rev=14070824#L2
 [FROM\_MDS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4631
 [FROM\_SANDBOX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4623
 [FULL\_JAVA\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L369
 [FUNCTION\_ORDERING\_FILE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L145
 [FUZZ\_DICTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1475
 [FUZZ\_OPTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1494
 [GENERATE\_ENUM\_SERIALIZATION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4278
 [GENERATE\_ENUM\_SERIALIZATION\_WITH\_HEADER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4290
 [GENERATE\_PY\_PROTOS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L600
 [GENERATE\_SCRIPT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/java.py?rev=14070824#L81
 [GENERATE\_YT\_RECORD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yt.conf?rev=14070824#L1
 [GEN\_SCHEEME2]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4372
 [GLOBAL\_CFLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4029
 [GLOBAL\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2314
 [GOLANG\_VERSION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L170
 [GO\_ASM\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L132
 [GO\_BENCH\_TIMEOUT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L941
 [GO\_CGO1\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L140
 [GO\_CGO2\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L148
 [GO\_COMPILE\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L156
 [GO\_EMBED\_BINDIR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L453
 [GO\_EMBED\_DIR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L420
 [GO\_EMBED\_PATTERN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L384
 [GO\_EMBED\_TEST\_DIR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L428
 [GO\_EMBED\_XTEST\_DIR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L436
 [GO\_FAKE\_OUTPUT]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/plugins/plugin_go_fake_output_handler.cpp?rev=14070824#L110
 [GO\_GRPC\_GATEWAY\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L518
 [GO\_GRPC\_GATEWAY\_SWAGGER\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L526
 [GO\_GRPC\_GATEWAY\_V2\_OPENAPI\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L573
 [GO\_GRPC\_GATEWAY\_V2\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L591
 [GO\_LDFLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L330
 [GO\_LINK\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L164
 [GO\_MOCKGEN\_CONTRIB\_FROM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L986
 [GO\_MOCKGEN\_FROM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L980
 [GO\_MOCKGEN\_MOCKS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L1017
 [GO\_MOCKGEN\_REFLECT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L997
 [GO\_MOCKGEN\_TYPES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L992
 [GO\_PACKAGE\_NAME]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L276
 [GO\_PROTO\_PLUGIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L355
 [GO\_PROTO\_USE\_V2]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L577
 [GO\_SKIP\_TESTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L358
 [GO\_TEST\_EMBED\_BINDIR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L461
 [GO\_TEST\_EMBED\_PATTERN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L392
 [GO\_TEST\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [GO\_TEST\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L295
 [GO\_XTEST\_EMBED\_BINDIR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L469
 [GO\_XTEST\_EMBED\_PATTERN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L400
 [GO\_XTEST\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/go.conf?rev=14070824#L306
 [GRPC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L549
 [GRPC\_WITH\_GMOCK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L570
 [HEADERS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5823
 [IDEA\_EXCLUDE\_DIRS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1564
 [IDEA\_MODULE\_NAME]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1584
 [IDEA\_RESOURCE\_DIRS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1574
 [IF]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [INCLUDE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [INCLUDE\_ONCE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [INCLUDE\_TAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [INDUCED\_DEPS]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [IOS\_APP\_ASSETS\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5538
 [IOS\_APP\_COMMON\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5532
 [IOS\_APP\_SETTINGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ios_app_settings.py?rev=14070824#L5
 [IOS\_ASSETS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ios_assets.py?rev=14070824#L6
 [JAR\_ANNOTATION\_PROCESSOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L455
 [JAR\_EXCLUDE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1949
 [JAR\_INCLUDE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1941
 [JAR\_MAIN\_CLASS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L885
 [JAR\_RESOURCE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L525
 [JAVAC\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1593
 [JAVA\_DEPENDENCIES\_CONFIGURATION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1925
 [JAVA\_EXTERNAL\_DEPENDENCIES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1894
 [JAVA\_IGNORE\_CLASSPATH\_CLASH\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5502
 [JAVA\_MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/java.py?rev=14070824#L97
 [JAVA\_PROTO\_PLUGIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L189
 [JAVA\_RESOURCE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L780
 [JAVA\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1687
 [JAVA\_TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L1040
 [JAVA\_TEST\_DEPS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L1138
 [JDK\_VERSION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L2001
 [JOIN\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2813
 [JOIN\_SRCS\_GLOBAL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2824
 [JUNIT\_TESTS\_JAR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L89
 [JVM\_ARGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1412
 [KAPT\_ANNOTATION\_PROCESSOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L629
 [KAPT\_ANNOTATION\_PROCESSOR\_CLASSPATH]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L636
 [KAPT\_OPTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L622
 [KOTLINC\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1790
 [KTLINT\_BASELINE\_FILE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L2038
 [LARGE\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4641
 [LDFLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4011
 [LICENSE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/license.conf?rev=14070824#L26
 [LICENSE\_RESTRICTION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/license.conf?rev=14070824#L52
 [LICENSE\_RESTRICTION\_EXCEPTIONS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/license.conf?rev=14070824#L75
 [LICENSE\_TEXTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5745
 [LINKER\_SCRIPT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/linker_script.py?rev=14070824#L1
 [LINK\_EXEC\_DYN\_LIB\_IMPL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1057
 [LINK\_EXE\_IMPL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1051
 [LINT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1649
 [LIST\_PROTO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L628
 [LJ\_21\_ARCHIVE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/lj_archive.py?rev=14070824#L25
 [LJ\_ARCHIVE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/lj_archive.py?rev=14070824#L1
 [LLVM\_BC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/llvm_bc.py?rev=14070824#L4
 [LLVM\_COMPILE\_C]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4725
 [LLVM\_COMPILE\_CXX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4711
 [LLVM\_COMPILE\_LL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4762
 [LLVM\_LINK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4772
 [LLVM\_LLC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4793
 [LLVM\_OPT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4782
 [LOCAL\_JAR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L535
 [LOCAL\_SOURCES\_JAR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L540
 [MACROS\_WITH\_ERROR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/macros_with_error.py?rev=14070824#L8
 [MANUAL\_GENERATION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3135
 [MASMFLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4036
 [MAVEN\_GROUP\_ID]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1630
 [MESSAGE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [MODULEWISE\_LICENSE\_RESTRICTION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/license.conf?rev=14070824#L67
 [MSVC\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5780
 [NEED\_CHECK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4308
 [NEED\_REVIEW]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4326
 [NGINX\_MODULES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5722
 [NO\_BUILD\_IF]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [NO\_CHECK\_IMPORTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4849
 [NO\_CLANG\_COVERAGE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4239
 [NO\_CLANG\_TIDY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4251
 [NO\_COMPILER\_WARNINGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4097
 [NO\_CPU\_CHECK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2950
 [NO\_CYTHON\_COVERAGE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L908
 [NO\_DEBUG\_INFO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4672
 [NO\_DOCTESTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L262
 [NO\_EXPORT\_DYNAMIC\_SYMBOLS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1254
 [NO\_EXTENDED\_SOURCE\_SEARCH]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L206
 [NO\_IMPORT\_TRACING]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L899
 [NO\_JOIN\_SRC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4211
 [NO\_LIBC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4165
 [NO\_LINT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1642
 [NO\_LTO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L389
 [NO\_MYPY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L443
 [NO\_NEED\_CHECK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4316
 [NO\_OPTIMIZE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4087
 [NO\_OPTIMIZE\_PY\_PROTOS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L139
 [NO\_PLATFORM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4176
 [NO\_PROFILE\_RUNTIME]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4247
 [NO\_PYTHON\_COVERAGE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L891
 [NO\_RUNTIME]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4154
 [NO\_SANITIZE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4219
 [NO\_SANITIZE\_COVERAGE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4231
 [NO\_SPLIT\_DWARF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2602
 [NO\_SSE4]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2942
 [NO\_TS\_TYPECHECK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_test.conf?rev=14070824#L209
 [NO\_UTIL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4143
 [NO\_WERROR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4113
 [NO\_WSHADOW]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4119
 [NO\_YMAKE\_PYTHON3]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L164
 [NVCC\_DEVICE\_LINK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4067
 [ONLY\_TAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [OPENSOURCE\_EXPORT\_REPLACEMENT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/opensource.conf?rev=14070824#L66
 [ORIGINAL\_SOURCE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5732
 [OWNER]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [PACK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2358
 [PACKAGE\_STRICT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2363
 [PACK\_GLOBALS\_IN\_LIBRARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/linkers/ld.conf?rev=14070824#L347
 [PARTITIONED\_RECURSE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [PARTITIONED\_RECURSE\_FOR\_TESTS]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [PARTITIONED\_RECURSE\_ROOT\_RELATIVE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [PEERDIR]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [PIRE\_INLINE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3893
 [PIRE\_INLINE\_CMD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3888
 [POPULATE\_CPP\_COVERAGE\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/coverage_full_instrumentation.conf?rev=14070824#L3
 [PREPARE\_INDUCED\_DEPS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4435
 [PROCESS\_DOCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/docs.py?rev=14070824#L38
 [PROCESS\_MKDOCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/plugins/mkdocs.py?rev=14070824#L38
 [PROGUARD\_RULES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/maps/aar.conf?rev=14070824#L13
 [PROTO2FBS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/fbs.conf?rev=14070824#L151
 [PROTOC\_FATAL\_WARNINGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L119
 [PROTO\_ADDINCL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L92
 [PROTO\_CMD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L845
 [PROTO\_NAMESPACE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L109
 [PROVIDES]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [PYTHON2\_ADDINCL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L763
 [PYTHON2\_MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L469
 [PYTHON3\_ADDINCL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L811
 [PYTHON3\_MODULE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L481
 [PYTHON\_PATH]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1622
 [PY\_CONSTRUCTOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/pybuild.py?rev=14070824#L785
 [PY\_DOCTESTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/pybuild.py?rev=14070824#L712
 [PY\_ENUMS\_SERIALIZATION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/pybuild.py?rev=14070824#L800
 [PY\_EXTRALIBS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/extralibs.py?rev=14070824#L1
 [PY\_EXTRA\_LINT\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L994
 [PY\_MAIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/pybuild.py?rev=14070824#L768
 [PY\_NAMESPACE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L517
 [PY\_PROTOS\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [PY\_PROTO\_PLUGIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L162
 [PY\_PROTO\_PLUGIN2]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L174
 [PY\_REGISTER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/pybuild.py?rev=14070824#L730
 [PY\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L939
 [REAL\_LINK\_DYN\_LIB\_IMPL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1045
 [REAL\_LINK\_EXEC\_DYN\_LIB\_IMPL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1039
 [REAL\_LINK\_EXE\_IMPL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1033
 [RECURSE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [RECURSE\_FOR\_TESTS]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [RECURSE\_ROOT\_RELATIVE]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [REGISTER\_SANDBOX\_IMPORT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/plugins/sandbox_registry.py?rev=14070824#L6
 [REGISTER\_YQL\_PYTHON\_UDF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/yql_python_udf.py?rev=14070824#L11
 [REQUIREMENTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1583
 [REQUIRES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L453
 [RESOLVE\_PROTO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L590
 [RESOURCE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L509
 [RESOURCE\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/res.py?rev=14070824#L14
 [RESTRICT\_PATH]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/macros_with_error.py?rev=14070824#L13
 [ROS\_CMD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/ros.conf?rev=14070824#L35
 [ROS\_DIR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/ros.conf?rev=14070824#L5
 [RUN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L1206
 [RUN\_ANTLR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4936
 [RUN\_ANTLR4]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4944
 [RUN\_ANTLR4\_CPP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4966
 [RUN\_ANTLR4\_CPP\_SPLIT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4958
 [RUN\_ANTLR4\_GO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4974
 [RUN\_ANTLR4\_PYTHON]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4987
 [RUN\_JAVA\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L447
 [RUN\_LUA]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4565
 [RUN\_PROGRAM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4539
 [RUN\_PYTHON3]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4590
 [SDBUS\_CPP\_ADAPTOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5701
 [SDBUS\_CPP\_PROXY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5707
 [SELECT\_CLANG\_SA\_CONFIG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L161
 [SET]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [SETUP\_EXECTEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L1212
 [SETUP\_PYTEST\_BIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L1199
 [SETUP\_RUN\_PYTHON]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L1290
 [SET\_APPEND]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [SET\_APPEND\_WITH\_GLOBAL]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [SET\_COMPILE\_OUTPUTS\_MODIFIERS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2970
 [SET\_CPP\_COVERAGE\_FLAGS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/coverage.py?rev=14070824#L61
 [SET\_LIST\_PRE\_SUF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/uservices.conf?rev=14070824#L18
 [SET\_RESOURCE\_MAP\_FROM\_JSON]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [SET\_RESOURCE\_URI\_FROM\_JSON]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [SIZE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2804
 [SKIP\_TEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1631
 [SOURCE\_GROUP]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [SPLIT\_CODEGEN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/plugins/split_codegen.py?rev=14070824#L9
 [SPLIT\_DWARF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2594
 [SPLIT\_FACTOR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2780
 [SRC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3512
 [SRCDIR]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3531
 [SRC\_C\_AMX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3666
 [SRC\_C\_AVX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3642
 [SRC\_C\_AVX2]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3650
 [SRC\_C\_AVX512]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3658
 [SRC\_C\_NO\_LTO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3748
 [SRC\_C\_PCLMUL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3683
 [SRC\_C\_PIC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3740
 [SRC\_C\_SSE2]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3602
 [SRC\_C\_SSE3]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3610
 [SRC\_C\_SSE4]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3626
 [SRC\_C\_SSE41]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3634
 [SRC\_C\_SSSE3]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3618
 [SRC\_C\_XOP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3675
 [SRC\_RESOURCE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L530
 [STRIP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4081
 [STRUCT\_CODEGEN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/codegen.conf?rev=14070824#L27
 [STYLE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1659
 [STYLE\_CPP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5814
 [STYLE\_PYTHON]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L242
 [STYLE\_RUFF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L253
 [SUBSCRIBER]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [SUPPRESSIONS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/suppressions.py?rev=14070824#L1
 [SYMLINK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4378
 [SYSTEM\_PROPERTIES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1401
 [TAG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1572
 [TASKLET]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5007
 [TASKLET\_REG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5024
 [TASKLET\_REG\_EXT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5039
 [TEST\_CWD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2495
 [TEST\_DATA]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/ytest.py?rev=14070824#L44
 [TEST\_JAVA\_CLASSPATH\_CMD\_TYPE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1908
 [TEST\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1519
 [TIMEOUT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2725
 [TOUCH\_RANDOM\_FILE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/plugins/touch_random_file.py?rev=14070824#L16
 [TS\_CONFIG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts.conf?rev=14070824#L19
 [TS\_ESLINT\_CONFIG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts.conf?rev=14070824#L97
 [TS\_EXCLUDE\_FILES\_GLOB]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts.conf?rev=14070824#L58
 [TS\_FILES]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts.conf?rev=14070824#L144
 [TS\_NEXT\_CONFIG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_next.conf?rev=14070824#L8
 [TS\_NEXT\_OUTPUT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_next.conf?rev=14070824#L20
 [TS\_TEST\_CONFIG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_test.conf?rev=14070824#L158
 [TS\_TEST\_DATA]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_test.conf?rev=14070824#L193
 [TS\_TEST\_DEPENDS\_ON\_BUILD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_test.conf?rev=14070824#L202
 [TS\_TEST\_FOR]: https://a.yandex-team.ru/arc/trunk/arcadia/devtools/ymake/yndex/builtin.cpp?rev=14070824#L14
 [TS\_TEST\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_test.conf?rev=14070824#L170
 [TS\_TYPECHECK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_test.conf?rev=14070824#L213
 [TS\_VITE\_CONFIG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_vite.conf?rev=14070824#L8
 [TS\_VITE\_OUTPUT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_vite.conf?rev=14070824#L20
 [TS\_WEBPACK\_CONFIG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_webpack.conf?rev=14070824#L8
 [TS\_WEBPACK\_OUTPUT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_webpack.conf?rev=14070824#L19
 [UBERJAR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1455
 [UBERJAR\_APPENDING\_TRANSFORMER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1540
 [UBERJAR\_HIDE\_EXCLUDE\_PATTERN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1484
 [UBERJAR\_HIDING\_PREFIX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1469
 [UBERJAR\_MANIFEST\_TRANSFORMER\_ATTRIBUTE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1524
 [UBERJAR\_MANIFEST\_TRANSFORMER\_MAIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1511
 [UBERJAR\_PATH\_EXCLUDE\_PREFIX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1498
 [UBERJAR\_SERVICES\_RESOURCE\_TRANSFORMER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1553
 [UDF\_NO\_PROBE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L26
 [UPDATE\_VCS\_JAVA\_INFO\_NODEP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3944
 [USE\_COMMON\_GOOGLE\_APIS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L312
 [USE\_CXX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4186
 [USE\_DYNAMIC\_CUDA]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1269
 [USE\_ERROR\_PRONE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1431
 [USE\_IDL\_CPP]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/maps/mapkit.conf?rev=14070824#L61
 [USE\_JAVALITE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L468
 [USE\_KTLINT\_OLD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L2028
 [USE\_LINKER\_GOLD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L843
 [USE\_LLVM\_BC14]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4688
 [USE\_LLVM\_BC16]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4693
 [USE\_MODERN\_FLEX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L109
 [USE\_MODERN\_FLEX\_WITH\_HEADER]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L120
 [USE\_NASM]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4203
 [USE\_OLD\_FLEX]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/bison_lex.conf?rev=14070824#L129
 [USE\_PERL\_514\_LIB]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/perl.conf?rev=14070824#L94
 [USE\_PERL\_LIB]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/perl.conf?rev=14070824#L87
 [USE\_PLANTUML]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/docs.conf?rev=14070824#L228
 [USE\_PYTHON2]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L860
 [USE\_PYTHON3]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/python.conf?rev=14070824#L877
 [USE\_RECIPE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1610
 [USE\_SA\_PLUGINS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L170
 [USE\_SKIFF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L263
 [USE\_UTIL]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4194
 [USRV\_ALL\_SRCS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/uservices.conf?rev=14070824#L38
 [USRV\_BUILD]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/uservices.conf?rev=14070824#L5
 [USRV\_GEN\_GRPC\_CLIENT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/uservices.conf?rev=14070824#L64
 [USRV\_GEN\_GRPC\_SERVICE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/uservices.conf?rev=14070824#L70
 [VALIDATE\_DATA\_RESTART]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L2735
 [VALIDATE\_IN\_DIRS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/plugins/macros_with_error.py?rev=14070824#L35
 [VCS\_INFO\_FILE]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3958
 [VERSION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4335
 [VISIBILITY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5679
 [VITE\_OUTPUT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_vite.conf?rev=14070824#L25
 [WEBPACK\_OUTPUT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/ts/ts_webpack.conf?rev=14070824#L24
 [WERROR]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L4106
 [WINDOWS\_LONG\_PATH\_MANIFEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5664
 [WINDOWS\_MANIFEST]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5659
 [WITHOUT\_LICENSE\_TEXTS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5753
 [WITH\_DYNAMIC\_LIBS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1027
 [WITH\_GROOVY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1781
 [WITH\_JDK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1743
 [WITH\_KAPT]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1772
 [WITH\_KOTLIN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1761
 [WITH\_KOTLINC\_ALLOPEN]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1807
 [WITH\_KOTLINC\_LOMBOK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1818
 [WITH\_KOTLINC\_NOARG]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1830
 [WITH\_KOTLINC\_SERIALIZATION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/java.conf?rev=14070824#L1842
 [WITH\_KOTLIN\_GRPC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L200
 [XSTYPEMAPS]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/perl.conf?rev=14070824#L80
 [XS\_PROTO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L506
 [YABS\_GENERATE\_CONF]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/plugins/yabs_generate_conf.py?rev=14070824#L10
 [YABS\_GENERATE\_PHANTOM\_CONF\_PATCH]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/plugins/yabs_generate_conf.py?rev=14070824#L41
 [YABS\_GENERATE\_PHANTOM\_CONF\_TEST\_CHECK]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/plugins/yabs_generate_conf.py?rev=14070824#L51
 [YA\_CONF\_JSON]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L5791
 [YDL\_DESC\_USE\_BINARY]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L3503
 [YMAPS\_SPROTO]: https://a.yandex-team.ru/arc/trunk/arcadia/build/internal/conf/project_specific/maps/sproto.conf?rev=14070824#L16
 [YQL\_ABI\_VERSION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L250
 [YQL\_LAST\_ABI\_VERSION]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/project_specific/yql_udf.conf?rev=14070824#L259
 [YT\_ORM\_PROTO\_YSON]: https://a.yandex-team.ru/arc/trunk/arcadia/build/conf/proto.conf?rev=14070824#L380
 [YT\_SPEC]: https://a.yandex-team.ru/arc/trunk/arcadia/build/ymake.core.conf?rev=14070824#L1508
