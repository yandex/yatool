...
## Table of contents
   ...
   * [Macros](#macros)
       - Macros [ACCELEO](#macro_ACCELEO) .. [ADD_IWYU](#macro_ADD_IWYU)
       - Macros [ADD_PYTEST_BIN](#macro_ADD_PYTEST_BIN) .. [ALL_PY_SRCS](#macro_ALL_PY_SRCS)
       - Macros [ALL_RESOURCE_FILES](#macro_ALL_RESOURCE_FILES) .. [ASSERT](#macro_ASSERT)
       - Macros [AUTO_SERVICE](#macro_AUTO_SERVICE) .. [BUILDWITH_CYTHON_C](#macro_BUILDWITH_CYTHON_C)
       - Macros [BUILDWITH_CYTHON_CPP](#macro_BUILDWITH_CYTHON_CPP) .. [CGO_LDFLAGS](#macro_CGO_LDFLAGS)
       - Macros [CGO_SRCS](#macro_CGO_SRCS) .. [CMAKE_EXPORTED_TARGET_NAME](#macro_CMAKE_EXPORTED_TARGET_NAME)
       - Macros [COLLECT_CONFIG_FILES](#macro_COLLECT_CONFIG_FILES) .. [COMPILE_LUA_OPENRESTY](#macro_COMPILE_LUA_OPENRESTY)
       - Macros [CONFIGURE_FILE](#macro_CONFIGURE_FILE) .. [CPP_ENUMS_SERIALIZATION](#macro_CPP_ENUMS_SERIALIZATION)
       - Macros [CPP_EVLOG](#macro_CPP_EVLOG) .. [CTEMPLATE_VARNAMES](#macro_CTEMPLATE_VARNAMES)
       - Macros [CUDA_NVCC_FLAGS](#macro_CUDA_NVCC_FLAGS) .. [DEB_VERSION](#macro_DEB_VERSION)
       - Macros [DECIMAL_MD5_LOWER_32_BITS](#macro_DECIMAL_MD5_LOWER_32_BITS) .. [DEFAULT_JDK_VERSION](#macro_DEFAULT_JDK_VERSION)
       - Macros [DEFAULT_JUNIT_JAVA_SRCS_LAYOUT](#macro_DEFAULT_JUNIT_JAVA_SRCS_LAYOUT) .. [DOCS_COPY_FILES](#macro_DOCS_COPY_FILES)
       - Macros [DOCS_DIR](#macro_DOCS_DIR) .. [ENABLE_PREVIEW](#macro_ENABLE_PREVIEW)
       - Macros [END](#macro_END) .. [EXPORTS_SCRIPT](#macro_EXPORTS_SCRIPT)
       - Macros [EXPORT_ALL_DYNAMIC_SYMBOLS](#macro_EXPORT_ALL_DYNAMIC_SYMBOLS) .. [FLAT_JOIN_SRCS_GLOBAL](#macro_FLAT_JOIN_SRCS_GLOBAL)
       - Macros [FLEX_FLAGS](#macro_FLEX_FLAGS) .. [FUNCTION_ORDERING_FILE](#macro_FUNCTION_ORDERING_FILE)
       - Macros [FUZZ_DICTS](#macro_FUZZ_DICTS) .. [GLOBAL_CFLAGS](#macro_GLOBAL_CFLAGS)
       - Macros [GLOBAL_SRCS](#macro_GLOBAL_SRCS) .. [GO_EMBED_PATTERN](#macro_GO_EMBED_PATTERN)
       - Macros [GO_EMBED_TEST_DIR](#macro_GO_EMBED_TEST_DIR) .. [GO_MOCKGEN_FROM](#macro_GO_MOCKGEN_FROM)
       - Macros [GO_MOCKGEN_MOCKS](#macro_GO_MOCKGEN_MOCKS) .. [GO_PACKAGE_NAME](#macro_GO_PACKAGE_NAME)
       - Macros [GO_PROTO_PLUGIN](#macro_GO_PROTO_PLUGIN) .. [GO_XTEST_EMBED_BINDIR](#macro_GO_XTEST_EMBED_BINDIR)
       - Macros [GO_XTEST_EMBED_PATTERN](#macro_GO_XTEST_EMBED_PATTERN) .. [INCLUDE](#macro_INCLUDE)
       - Macros [INCLUDE_ONCE](#macro_INCLUDE_ONCE) .. [JAR_ANNOTATION_PROCESSOR](#macro_JAR_ANNOTATION_PROCESSOR)
       - Macros [JAR_EXCLUDE](#macro_JAR_EXCLUDE) .. [JAVA_RESOURCE](#macro_JAVA_RESOURCE)
       - Macros [JAVA_RESOURCE_TAR](#macro_JAVA_RESOURCE_TAR) .. [JVM_ARGS](#macro_JVM_ARGS)
       - Macros [KAPT_ANNOTATION_PROCESSOR](#macro_KAPT_ANNOTATION_PROCESSOR) .. [LD_PLUGIN](#macro_LD_PLUGIN)
       ...
       - Macros [NO_CLANG_COVERAGE](#macro_NO_CLANG_COVERAGE) .. [NO_DOCTESTS](#macro_NO_DOCTESTS)
       - Macros [NO_EXPORT_DYNAMIC_SYMBOLS](#macro_NO_EXPORT_DYNAMIC_SYMBOLS) .. [NO_NEED_CHECK](#macro_NO_NEED_CHECK)
       - Macros [NO_OPTIMIZE](#macro_NO_OPTIMIZE) .. [NO_SSE4](#macro_NO_SSE4)
       - Macros [NO_TS_TYPECHECK](#macro_NO_TS_TYPECHECK) .. [ORIGINAL_SOURCE](#macro_ORIGINAL_SOURCE)
       - Macros [PACK](#macro_PACK) .. [POPULATE_CPP_YNDEXING](#macro_POPULATE_CPP_YNDEXING)
       - Macros [PREPARE_INDUCED_DEPS](#macro_PREPARE_INDUCED_DEPS) .. [PROTO_TO_NAMESPACE](#macro_PROTO_TO_NAMESPACE)
       - Macros [PROVIDES](#macro_PROVIDES) .. [PY_EXTRALIBS](#macro_PY_EXTRALIBS)
       - Macros [PY_EXTRA_LINT_FILES](#macro_PY_EXTRA_LINT_FILES) .. [RECURSE_FOR_TESTS](#macro_RECURSE_FOR_TESTS)
       - Macros [RECURSE_ROOT_RELATIVE](#macro_RECURSE_ROOT_RELATIVE) .. [RESTRICT_PATH](#macro_RESTRICT_PATH)
       - Macros [RISK_GEN_DATA_MODEL](#macro_RISK_GEN_DATA_MODEL) .. [RUN_ANTLR4_PYTHON3](#macro_RUN_ANTLR4_PYTHON3)
       - Macros [RUN_JAVASCRIPT](#macro_RUN_JAVASCRIPT) .. [SDC_DIAGS_SPLIT_GENERATOR_V3](#macro_SDC_DIAGS_SPLIT_GENERATOR_V3)
       - Macros [SDC_DIAGS_SPLIT_GENERATOR_V4](#macro_SDC_DIAGS_SPLIT_GENERATOR_V4) .. [SET_APPEND_WITH_GLOBAL](#macro_SET_APPEND_WITH_GLOBAL)
       - Macros [SET_COMPILE_OUTPUTS_MODIFIERS](#macro_SET_COMPILE_OUTPUTS_MODIFIERS) .. [SPLIT_DWARF](#macro_SPLIT_DWARF)
       - Macros [SPLIT_FACTOR](#macro_SPLIT_FACTOR) .. [SRC_C_PIC](#macro_SRC_C_PIC)
       - Macros [SRC_C_SSE2](#macro_SRC_C_SSE2) .. [STYLE_DETEKT](#macro_STYLE_DETEKT)
       - Macros [STYLE_DUMMY](#macro_STYLE_DUMMY) .. [SUPPRESSIONS](#macro_SUPPRESSIONS)
       - Macros [SYMLINK](#macro_SYMLINK) .. [TEST_SRCS](#macro_TEST_SRCS)
       - Macros [THINLTO_CACHE](#macro_THINLTO_CACHE) .. [TS_EXCLUDE_FILES_GLOB](#macro_TS_EXCLUDE_FILES_GLOB)
       - Macros [TS_FILES](#macro_TS_FILES) .. [TS_PROTO_PACKAGE_NAME](#macro_TS_PROTO_PACKAGE_NAME)
       - Macros [TS_RSPACK_CONFIG](#macro_TS_RSPACK_CONFIG) .. [TS_TYPECHECK](#macro_TS_TYPECHECK)
       - Macros [TS_USE_BUN](#macro_TS_USE_BUN) .. [UBERJAR_HIDING_PREFIX](#macro_UBERJAR_HIDING_PREFIX)
       - Macros [UBERJAR_MANIFEST_TRANSFORMER_ATTRIBUTE](#macro_UBERJAR_MANIFEST_TRANSFORMER_ATTRIBUTE) .. [USE_CXX](#macro_USE_CXX)
       - Macros [USE_DYNAMIC_CUDA](#macro_USE_DYNAMIC_CUDA) .. [USE_MODERN_FLEX](#macro_USE_MODERN_FLEX)
       - Macros [USE_MODERN_FLEX_WITH_HEADER](#macro_USE_MODERN_FLEX_WITH_HEADER) .. [USE_UTIL](#macro_USE_UTIL)
       - Macros [USRV_GEN_GRPC_CLIENT_V2](#macro_USRV_GEN_GRPC_CLIENT_V2) .. [VISIBILITY](#macro_VISIBILITY)
       - Macros [VITE_OUTPUT](#macro_VITE_OUTPUT) .. [WITH_KOTLIN](#macro_WITH_KOTLIN)
       - Macros [WITH_KOTLINC_ALLOPEN](#macro_WITH_KOTLINC_ALLOPEN) .. [YABS_GENERATE_PHANTOM_CONF_PATCH](#macro_YABS_GENERATE_PHANTOM_CONF_PATCH)
...
###### Multimodule [JUNIT6][] <a name="multimodule_JUNIT6"></a>
Not documented yet.
...
###### Multimodule [TS\_LIBRARY][]([name]) <a name="multimodule_TS_LIBRARY"></a>
...
Documentation: https://docs.yandex-team.ru/frontend-in-arcadia/references/TS\_LIBRARY
...
###### Multimodule [TS\_RSPACK][]([name]) <a name="multimodule_TS_RSPACK"></a>
The Rspack bundle, bundles JavaScript code.
Build results are packed as `output.tar`.

Documentation: https://docs.yandex-team.ru/frontend-in-arcadia/references/TS\_RSPACK
...
###### Multimodule [TS\_TEST\_FOR][] <a name="multimodule_TS_TEST_FOR"></a>
Not documented yet.
...
###### Module [DOCS\_HTML][]() <a name="module_DOCS_HTML"></a>
This module provides the HTML archive output from the DOCS multimodule. You have to call
DOCS\_HTML\_FROM macro to specify the path to the DOCS module at least once. If there are
several calls to DOCS\_HTML\_FROM macro the last one wins (that is the last call to
DOCS\_HTML\_FROM is considered and all others are ignored).

@see: [DOCS\_HTML\_FROM()](#macro\_DOCS\_HTML\_FROM), [DOCS()](#module\_DOCSS).
...
###### Module [JAVA\_TEST\_LIBRARY][]: JAR\_LIBRARY <a name="module_JAVA_TEST_LIBRARY"></a>
Not documented yet.
...
###### Module [TS\_TEST\_VITEST\_FOR][](Path) <a name="module_TS_TEST_VITEST_FOR"></a>
Defines testing module with vitest test runner.

Documentation: https://docs.yandex-team.ru/frontend-in-arcadia/references/TS\_TEST\_VITEST\_FOR
...
###### Module [YQL\_UDF\_MINITEST][]([name]) <a name="module_YQL_UDF_MINITEST"></a>
The module to test YQL C++ UDF via minirun (pure provider, no external data sources).
Test SQL files use inline data (AsList/AS\_TABLE) for input instead of .in files.
...
###### Macro [ADD\_IWYU][]() <a name="macro_ADD_IWYU"></a>
Not documented yet.
...
###### Macro [ALLOCATOR][](Alloc) <a name="macro_ALLOCATOR"></a>
...
Different platforms have different default allocators (for example, Linux x86-64 uses TCMALLOC\_TC for builds w/o MUSL, Darwin uses SYSTEM).
See DEFAULT\_ALLOCATOR variable definition.
...
Available allocators are:
  ...
  - TCMALLOC\_256K - TCMalloc with 256k pages (usually faster but fragmentation is higher) + huge page awareness (https://github.com/yandex/yatool/tree/main/contrib/libs/tcmalloc/default)
  - TCMALLOC\_SMALL\_BUT\_SLOW (https://github.com/yandex/yatool/tree/main/contrib/libs/tcmalloc/small\_but\_slow)
  ...
  - TCMALLOC\_NUMA\_256K - TCMalloc with 256k pages (usually faster but fragmentation is higher) + NUMA awareness (https://github.com/yandex/yatool/tree/main/contrib/libs/tcmalloc/numa\_256k)
  - TCMALLOC\_NUMA\_LARGE\_PAGES - TCMalloc with large pages (usually faster but fragmentation is higher) + NUMA awareness (https://github.com/yandex/yatool/tree/main/contrib/libs/tcmalloc/numa\_large\_pages)
  - TCMALLOC\_TC - TCMalloc with 256k pages (usually faster but fragmentation is higher) + huge page awareness + Per-thread mode (https://github.com/yandex/yatool/tree/main/contrib/libs/tcmalloc/no\_percpu\_cache)
  ...
  - PROFILED\_HU - patched HU (https://a.yandex-team.ru/arcadia/library/cpp/malloc/profiled\_hu). It is a bit slower but has metrics of memory consumption.
  - THREAD\_PROFILED\_HU - patched (special for market) HU (https://a.yandex-team.ru/arcadia/library/cpp/malloc/thread\_profiled\_hu). It is a bit slower but has metrics of memory consumption.
...
###### Macro [ALL\_GO\_SRCS][]() <a name="macro_ALL_GO_SRCS"></a>
...
###### Macro [ALL\_PY\_EXTRA\_LINT\_FILES][]([Dirs...]) <a name="macro_ALL_PY_EXTRA_LINT_FILES"></a>
Add all Python .py-files from current directory for linting. Normally the files are added by
PY\_SRCS / TEST\_SRCS macros. This macro can be used when source files' layout causes linting
...
`PREFIX` and `STRIP` have the same meaning as in `RESOURCE\_FILES`, both are applied over moddir-relative paths
...
###### Macro [BUNDLE\_OUTPUT][](Dir OutputName [RENAME <Rename>]) <a name="macro_BUNDLE_OUTPUT"></a>
`Dir` - Path to module
...
###### Macro [CLANG\_WARNINGS][](Args...) <a name="macro_CLANG_WARNINGS"></a>
Not documented yet.
...
###### Macro [COLLECT\_CONFIG\_FILES][](Varname, Dir, Exts...) <a name="macro_COLLECT_CONFIG_FILES"></a>
...
###### Macro [COLLECT\_KOTLIN\_LINT\_SRCS][]([DIRS dirs] [DIRS\_RECURSE dirs\_recurse]) <a name="macro_COLLECT_KOTLIN_LINT_SRCS"></a>
Not documented yet.
...
###### Macro [CONFTEST\_LOAD\_POLICY\_LEGACY\_GLOBAL][]() <a name="macro_CONFTEST_LOAD_POLICY_LEGACY_GLOBAL"></a>
...
\* https://docs.pytest.org/en/stable/how-to/writing\_plugins.html#plugin-discovery-order-at-tool-startup
...
###### Macro [COPY\_FILE][](File Destination [AUTO] [OUTPUT\_INCLUDES...] [INDUCED\_DEPS...] [TEXT]) <a name="macro_COPY_FILE"></a>
...
###### Macro [COPY\_FILE\_WITH\_CONTEXT][](File Dest [AUTO] [OUTPUT\_INCLUDES...] [INDUCED\_DEPS...]) <a name="macro_COPY_FILE_WITH_CONTEXT"></a>
Copy file to build root the same way as it is done for COPY\_FILE, but also
propagates the context of the source file.

###### Macro [COW][]() <a name="macro_COW"></a>
Not documented yet.
...
###### Macro [CPP\_EVLOG][]() <a name="macro_CPP_EVLOG"></a>
Apply event2cpp proto plugin for all .proto files of PROTO\_LIBRARY.
This macro affects only c++ code generation - CPP\_PROTO submodule.

###### Macro [CPP\_EV\_PROTO\_PLUGIN][](Name Tool Suf [DEPS <Dependencies>] [EXTRA\_OUT\_FLAG <ExtraOutFlag>]) <a name="macro_CPP_EV_PROTO_PLUGIN"></a>
Like CPP\_PROTO\_PLUGIN, but also applies the plugin to .ev files in PROTO\_LIBRARY.
...
###### Macro [CUDA\_SRCS][](File...) <a name="macro_CUDA_SRCS"></a>
...
CUDA\_ARCHITECTURES variable is used to determine the list of architectures to compile device code for.
...
###### Macro [DISABLE\_DATA\_VALIDATION][](Args...) <a name="macro_DISABLE_DATA_VALIDATION"></a>
Not documented yet.
...
###### Macro [DOCS\_HTML\_FROM][](Dir Name) <a name="macro_DOCS_HTML_FROM"></a>
...
###### Macro [EXPERIMENTAL\_FORK][]() <a name="macro_EXPERIMENTAL_FORK"></a>
Only for java-tests: same as FORK\_(SUB)TESTS(SEQUENTIAL) for other languages
...
Generates mocks, expect to have `gen` folder with GO\_MOCKGEN\_REFLECT

###### Macro [GO\_MOCKGEN\_PACKAGE][](package) <a name="macro_GO_MOCKGEN_PACKAGE"></a>
...
###### Macro [GO\_MOCKGEN\_SOURCE][](FILE, ARGS[], IN\_NOPARSE[]) <a name="macro_GO_MOCKGEN_SOURCE"></a>
Part of Go mock module definition, source mode.
Generates mocks from file from GO\_MOCKGEN\_FROM or GO\_MOCKGEN\_CONTRIB\_FROM
Can be placed multiple times in same ya.make

###### Macro [GO\_MOCKGEN\_TYPES][](Types...) <a name="macro_GO_MOCKGEN_TYPES"></a>
Not documented yet.

###### Macro [GO\_OAPI\_CODEGEN][](GENERATE, PACKAGE, IN, IN\_NOPARSE[], Args...) <a name="macro_GO_OAPI_CODEGEN"></a>
...
IN\_NOPARSE - input files required for running generation, except IN
Can be placed multiple times in same ya.make

###### Macro [GO\_OAPI\_CODEGEN\_TAXI][] <a name="macro_GO_OAPI_CODEGEN_TAXI"></a>
private, taxi only

###### Macro [GO\_OAPI\_CODEGEN\_TAXI\_1134][] <a name="macro_GO_OAPI_CODEGEN_TAXI_1134"></a>
private, taxi only

###### Macro [GO\_OAPI\_CODEGEN\_V2][](GENERATE, PACKAGE, IN, IN\_NOPARSE[], Args...) <a name="macro_GO_OAPI_CODEGEN_V2"></a>
...
For example, see devtools/dummy\_arcadia/go/oapi-codegen-v2
...
###### Macro [GO\_SSO][](Command...) <a name="macro_GO_SSO"></a>
Not documented yet.

###### Macro [GO\_SSO\_TOOL][](Tool...) <a name="macro_GO_SSO_TOOL"></a>
Not documented yet.
...
###### Macro [INJECT\_PEERS][]() <a name="macro_INJECT_PEERS"></a>
Not documented yet.
...
###### Macro [IWYU\_MAPPING\_FILE][](mapping\_file) <a name="macro_IWYU_MAPPING_FILE"></a>
...
###### Macro [JAVA\_RESOURCE\_TAR][](tar\_path EXTRACT\_ROOT root\_dir) <a name="macro_JAVA_RESOURCE_TAR"></a>
Adds tar content as resources

Documentation: https://docs.yandex-team.ru/ya-make/manual/java/macros#java\_resource\_tar
...
###### Macro [KAPT\_ANNOTATION\_PROCESSOR\_OPTIONS][](Opts...) <a name="macro_KAPT_ANNOTATION_PROCESSOR_OPTIONS"></a>
...
###### Macro [KTLINT\_RULESET][](path/to/ruleset/module) <a name="macro_KTLINT_RULESET"></a>
...
###### Macro [NO\_CLANG\_MCDC\_COVERAGE][]() <a name="macro_NO_CLANG_MCDC_COVERAGE"></a>
...
###### Macro [NO\_IWYU][]() <a name="macro_NO_IWYU"></a>
...
###### Macro [OBJC\_FLAGS][](compiler\_flags) <a name="macro_OBJC_FLAGS"></a>
...
###### Macro [PARALLEL\_TESTS\_WITHIN\_NODE][](COUNT) <a name="macro_PARALLEL_TESTS_WITHIN_NODE"></a>
...
###### Macro [POPULATE\_CPP\_YNDEXING][]() <a name="macro_POPULATE_CPP_YNDEXING"></a>
Not documented yet.
...
###### Macro [PROTO\_TO\_NAMESPACE][]([IMPORT\_ALL\_IN\_INIT] [IN\_MSG|IN\_PROTO] python\_module ...) <a name="macro_PROTO_TO_NAMESPACE"></a>
Macro organizes generated proto modules from TOP\_LEVEL into a specified Python namespace within a PY3\_LIBRARY.
Use together with the PROTO\_LIBRARY, for place generated modules to namespace.
Avoid using this macros! Prefer proper Python and proto imports instead. Reserve for legacy codebases.

Parameters:
  IMPORT\_ALL\_IN\_INIT (optional) - generates \_\_init\_\_.py in the target subdirectory, importing all symbols from modules
  IN\_MSG|IN\_PROTO (optional, pick one) - Places modules in a subdirectory named `msg/` or `proto/` within the namespace.
                                         if not specified modules are placed directly in the namespace root.

  python\_module - list of proto-generated Python modules (e.g., `agent\_pb2`) to include.

Example:
    # path/to/proto\_library/ya.make
    PROTO\_LIBRARY()
        SRCS(agent.proto)
        PY\_NAMESPACE(.)  # Generates agent\_pb2 in TOP\_LEVEL
    END()
...
###### Macro [REQUIRE\_RESOURCE][](PeerdirPath RESOURCES Resources...) <a name="macro_REQUIRE_RESOURCE"></a>
...
###### Macro [RISK\_GEN\_DATA\_MODEL][] <a name="macro_RISK_GEN_DATA_MODEL"></a>
Not documented yet.
...
###### Macro [RUN\_ANTLR4\_PYTHON2][](Grammar [LISTENER] [VISITOR] [SUBDIR] [EXTRA\_OUTS Outs...] Args...) <a name="macro_RUN_ANTLR4_PYTHON2"></a>
...
###### Macro [RUN\_ANTLR4\_PYTHON3][](Grammar [LISTENER] [VISITOR] [SUBDIR] [EXTRA\_OUTS Outs...] Args...) <a name="macro_RUN_ANTLR4_PYTHON3"></a>
`LISTENER` - emit grammar listener
`VISITOR` -  emit grammar visitor
`SUBDIR` - place generated files to specified subdirectory of BINDIR
`EXTRA\_OUTS` - list extra outputs produced by Antlr (e.g. .interp and .token files) if they are needed. If `SUBDIR` is specied it will affect these as well. Use file names only.
...
- IN[\_NOPARSE] inputs... - Input files. NOPARSE inputs are treated as textual and not parsed for dependencies regardless of file extensions.
- OUT[\_NOAUTO] outputs... - Output files. NOAUTO outputs are not automatically added to the build process.
- OUT\_GLOBAL outputs... - Global output files.
- STDOUT[\_NOAUTO] output - Redirect the standard output to the output file.
- OUTPUT\_INCLUDES output\_includes... - Includes of the output files that are needed to build them.
- INDUCED\_DEPS $VARs... - Dependencies for generated files. Unlike `OUTPUT\_INCLUDES` these may target files further in processing chain.
                          In order to do so VAR should be filled by PREPARE\_INDUCED\_DEPS macro, stating target files (by type) and set of dependencies
...
###### Macro [SDC\_DIAGS\_SPLIT\_GENERATOR\_V3][] <a name="macro_SDC_DIAGS_SPLIT_GENERATOR_V3"></a>
Not documented yet.

###### Macro [SDC\_DIAGS\_SPLIT\_GENERATOR\_V4][] <a name="macro_SDC_DIAGS_SPLIT_GENERATOR_V4"></a>
Not documented yet.
...
###### Macro [SELECT\_PROTO\_LAYOUT][](PROTO\_LAYOUT) <a name="macro_SELECT_PROTO_LAYOUT"></a>
...
###### Macro [SET\_CUSTOM\_CLANG\_TIDY][](resource\_module\_path, var\_name) <a name="macro_SET_CUSTOM_CLANG_TIDY"></a>
Not documented yet.
...
###### Macro [STYLE\_DETEKT][]([CONFIG\_TYPE ct]) <a name="macro_STYLE_DETEKT"></a>
Not documented yet.
...
###### Macro [STYLE\_JSON][]([DIRS dirs] [DIRS\_RECURSE dirs\_recurse]) <a name="macro_STYLE_JSON"></a>
\_ADD\_PY\_LINTER\_CHECK(NAME name LINTER linter [DEPENDS deps] [DEFAULT\_CONFIGS configs\_file] [FILE\_PROCESSING\_TIME fpt] [EXTRA\_PARAMS params] [CONFIG\_TYPE ct])
...
###### Macro [STYLE\_RUFF][]([CONFIG\_TYPE config\_type] [CHECK\_FORMAT]) <a name="macro_STYLE_RUFF"></a>
Check python3 sources for style issues using ruff.
`CHECK\_FORMAT` enables `ruff format` check.
`RUN\_IN\_SOURCE\_ROOT` is a hacky option allowed for a limited number of projects, do not use it.

###### Macro [STYLE\_YAML][]([DIRS dirs] [DIRS\_RECURSE dirs\_recurse]) <a name="macro_STYLE_YAML"></a>
Not documented yet.

###### Macro [STYLE\_YQL][]([DIRS dirs] [DIRS\_RECURSE dirs\_recurse]) <a name="macro_STYLE_YQL"></a>
Not documented yet.
...
The most probable use is with `LARGE\_FILES` or `FROM\_SANDBOX` to bring cache from the storage.

In order to generate file use `-DTHINLTO\_CACHE=gen` option and the file with name `out-<File>`
...
storage, in case of using `FROM\_SANDBOX` the resource ID is to be [auto-]updated upon upload.
...
###### Macro [TS\_BIOME][](configFile) <a name="macro_TS_BIOME"></a>
For JavaScript, TypeScript, JSX, TSX, JSON, CSS and GraphQL. Must be inside of Module (TS\_WEBPACK, TS\_VITE, TS\_NEXT, etc)
...
###### Macro [TS\_BUILD\_ENV][](key=value) <a name="macro_TS_BUILD_ENV"></a>
Sets env variable key to value.

###### Macro [TS\_BUILD\_OUTPUTS][](PATHS...) <a name="macro_TS_BUILD_OUTPUTS"></a>
Not documented yet.

###### Macro [TS\_BUILD\_SCRIPT][](SCRIPT) <a name="macro_TS_BUILD_SCRIPT"></a>
Not documented yet.
...
###### Macro [TS\_LINT][](SCRIPT\_NAME, TIMEOUT\_MEDIUM?"yes":"no") <a name="macro_TS_LINT"></a>
Not documented yet.

###### Macro [TS\_NEXT\_BUILD\_OPTIONS][](Options...) <a name="macro_TS_NEXT_BUILD_OPTIONS"></a>
Macro sets the build options for TS\_NEXT module.

- Options - next build options.

Documentation: https://docs.yandex-team.ru/frontend-in-arcadia/references/TS\_NEXT#ts-next-build-options
...
###### Macro [TS\_NEXT\_EXPERIMENTAL\_BUILD\_MODE][]() <a name="macro_TS_NEXT_EXPERIMENTAL_BUILD_MODE"></a>
Macro tune the build command to use experimental build feature.
The method depends on the next.js version.

Documentation: https://docs.yandex-team.ru/frontend-in-arcadia/references/TS\_NEXT#ts-next-experimental-build-mode
...
Documentation: https://docs.yandex-team.ru/frontend-in-arcadia/references/TS\_PROTO#ts\_proto\_opt
...
###### Macro [TS\_PROTO\_PACKAGE\_NAME][](@scope/pkg) <a name="macro_TS_PROTO_PACKAGE_NAME"></a>
Sets package name for `TS\_PROTO`.
Use `@scope/\*` to set package scope with autogenerated name.

Documentation: https://docs.yandex-team.ru/frontend-in-arcadia/references/TS\_PROTO#ts\_proto\_package\_name
...
###### Macro [TS\_RSPACK\_CONFIG][](ConfigPath) <a name="macro_TS_RSPACK_CONFIG"></a>
Macro sets the config path for TS\_RSPACK module.

- ConfigPath - config path

Documentation: https://docs.yandex-team.ru/frontend-in-arcadia/references/TS\_RSPACK#ts-rspack-config

###### Macro [TS\_RSPACK\_OUTPUT][](FirstDirName DirNames) <a name="macro_TS_RSPACK_OUTPUT"></a>
Macro sets the output directory names (one at least) for TS\_RSPACK module.

- DirNames - output directory names (one at least)
Documentation: https://docs.yandex-team.ru/frontend-in-arcadia/references/TS\_RSPACK#ts-rspack-output
...
###### Macro [TS\_TEST][](SCRIPT\_NAME) <a name="macro_TS_TEST"></a>
Not documented yet.
...
###### Macro [TS\_TEST\_INCLUDE\_NODEJS][]() <a name="macro_TS_TEST_INCLUDE_NODEJS"></a>
...
###### Macro [TS\_USE\_BUN][]() <a name="macro_TS_USE_BUN"></a>
...
###### Macro [UDF\_NO\_SCAN][]() <a name="macro_UDF_NO_SCAN"></a>
...
###### Macro [USE\_LEGACY\_PNPM\_VIRTUAL\_STORE][]() <a name="macro_USE_LEGACY_PNPM_VIRTUAL_STORE"></a>
Not documented yet.
...
###### Macro [USE\_LLVM\_BC20][]() <a name="macro_USE_LLVM_BC20"></a>
Not documented yet.
...
###### Macro [USRV\_GEN\_GRPC\_CLIENT\_V2][] <a name="macro_USRV_GEN_GRPC_CLIENT_V2"></a>
Not documented yet.

###### Macro [USRV\_GEN\_GRPC\_CLIENT\_V2\_STRUCTS][] <a name="macro_USRV_GEN_GRPC_CLIENT_V2_STRUCTS"></a>
Not documented yet.

###### Macro [USRV\_GEN\_GRPC\_SERVICE\_V2][] <a name="macro_USRV_GEN_GRPC_SERVICE_V2"></a>
Not documented yet.

###### Macro [USRV\_GEN\_GRPC\_SERVICE\_V2\_STRUCTS][] <a name="macro_USRV_GEN_GRPC_SERVICE_V2_STRUCTS"></a>
Not documented yet.

###### Macro [USRV\_GEN\_PROTO\_STRUCTS][] <a name="macro_USRV_GEN_PROTO_STRUCTS"></a>
Not documented yet.
...
###### Macro [WITH\_NODE\_MODULES][]() <a name="macro_WITH_NODE_MODULES"></a>
Macro configures the project to output node\_modules bundle as a build-result.
...
###### Macro [YT\_RECORD\_DISABLE\_PEERDIR][]() <a name="macro_YT_RECORD_DISABLE_PEERDIR"></a>
Not documented yet.
...
###### Property .[ALIASES][]=FROM1=TO1 [FROM2=TO2] ... <a name="property_ALIASES"></a>
...
###### Property .[FINAL\_TARGET][]=yes|no <a name="property_FINAL_TARGET"></a>
Marks the module as a final build target.

###### Property .[GEN\_FROM\_FILE][]=yes <a name="property_GEN_FROM_FILE"></a>
...
###### Property .[GLOBAL][]=VAR1 [VAR2] ... <a name="property_GLOBAL"></a>
Makes listed variables global. For each listed name a corresponding NAME\_GLOBAL variable is created to collect values across dependent modules.

###### Property [GLOBAL\_CMD][] <a name="property_GLOBAL_CMD"></a>
Build command for global sources (e.g. SRCS(GLOBAL ...)). Must be accompanied by .GLOBAL\_EXTS.

###### Property .[GLOBAL\_EXTS][]=.ext1 .ext2 <a name="property_GLOBAL_EXTS"></a>
Specify extensions which are treated as global inputs and processed by .GLOBAL\_CMD.
...
###### Property .[PEERDIR\_POLICY][]=as\_include|as\_build\_from <a name="property_PEERDIR_POLICY"></a>
Controls how PEERDIRs to the module work. as\_build\_from makes dependants to just use results produced by the module; as\_include makes dependants to include the module as a whole (with transitive info, for example).

###### Property [PROXY][] <a name="property_PROXY"></a>
Not documented yet.

###### Property .[RESTRICTED][]=MACRO1 [MACRO2] ... <a name="property_RESTRICTED"></a>
...
###### Variable [DEPENDENCY\_MANAGEMENT\_TAGS\_EXCLUDE][] <a name="variable_DEPENDENCY_MANAGEMENT_TAGS_EXCLUDE"></a>
Module tags to exclude from managed peers closure for current module but propagate further

###### Variable [DEPENDENCY\_MANAGEMENT\_TRANSPARENT][] <a name="variable_DEPENDENCY_MANAGEMENT_TRANSPARENT"></a>
If yes: module does not apply local DEPENDENCY\_MANAGEMENT/EXCLUDE rules; its own MANAGED\_PEERS\_CLOSURE lists only direct PEERDIR module nodes. Upstream closure still expands through those directs' full managed closures. Requires HAS\_MANAGEABLE\_PEERS=yes
...
Not documented yet.
 ...
 [DLL\_JAVA]: https://github.com/yandex/yatool/tree/main/build/conf/swig.conf?rev=19715103#L90
 [DOCS]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L155
 [FBS\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19715103#L113
 [JAVA\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L106
 [JAVA\_CONTRIB\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L124
 [JAVA\_CONTRIB\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L378
 [JAVA\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L60
 [JTEST]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L281
 [JTEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L339
 [JUNIT5]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L221
 [JUNIT6]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L161
 [PACKAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2495
 [PROTO\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L916
 [PROTO\_SCHEMA]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L1003
 [PY23\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1211
 [PY23\_NATIVE\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1237
 [PY23\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1263
 [PY3TEST]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L515
 [PY3\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L347
 [TS\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_library.conf?rev=19715103#L38
 [TS\_NEXT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19715103#L73
 [TS\_PACKAGE]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_package.conf?rev=19715103#L13
 [TS\_RSPACK]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_rspack.conf?rev=19715103#L48
 [TS\_TEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_check.conf?rev=19715103#L16
 [TS\_TSC]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_tsc.conf?rev=19715103#L21
 [TS\_VITE]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_vite.conf?rev=19715103#L57
 [TS\_WEBPACK]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_webpack.conf?rev=19715103#L55
 [YQL\_UDF]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L183
 [YQL\_UDF\_CONTRIB]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L225
 [YQL\_UDF\_YDB]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L204
 [BOOSTTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1518
 [BOOSTTEST\_WITH\_MAIN]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1540
 [CI\_GROUP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2524
 [CUDA\_DEVICE\_LINK\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/cuda.conf?rev=19715103#L132
 [DEFAULT\_IOS\_INTERFACE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5523
 [DLL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2286
 [DLL\_TOOL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2303
 [DOCS\_HTML]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L236
 [DOCS\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L88
 [EXECTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1795
 [FAT\_OBJECT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2084
 [FUZZ]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1474
 [GEN\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L592
 [GO\_DLL]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1119
 [GO\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L993
 [GO\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1010
 [GO\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1139
 [GTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1450
 [G\_BENCHMARK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1833
 [IOS\_INTERFACE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5512
 [JAVA\_CONTRIB]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L724
 [JAVA\_CONTRIB\_PROXY]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L668
 [JAVA\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L15
 [JAVA\_TEST\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L19
 [LIBRARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1968
 [PROGRAM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1301
 [PROTO\_DESCRIPTIONS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L975
 [PROTO\_REGISTRY]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L988
 [PY2MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L602
 [PY2TEST]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L463
 [PY2\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L694
 [PY2\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L315
 [PY3MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L621
 [PY3TEST\_BIN]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L486
 [PY3\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L738
 [PY3\_PROGRAM\_BIN]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L915
 [PYTEST\_BIN]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L445
 [PY\_ANY\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L544
 [RECURSIVE\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2143
 [RESOURCES\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2043
 [R\_MODULE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2256
 [SO\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2315
 [TS\_TEST\_HERMIONE\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L92
 [TS\_TEST\_JEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L29
 [TS\_TEST\_PLAYWRIGHT\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L125
 [TS\_TEST\_PLAYWRIGHT\_LARGE\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L155
 [TS\_TEST\_VITEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L61
 [UNION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2546
 [UNITTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1395
 [UNITTEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1877
 [UNITTEST\_WITH\_CUSTOM\_ENTRY\_POINT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1431
 [YQL\_PYTHON3\_UDF]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L326
 [YQL\_PYTHON3\_UDF\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L377
 [YQL\_PYTHON\_UDF]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L269
 [YQL\_PYTHON\_UDF\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L298
 [YQL\_PYTHON\_UDF\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L363
 [YQL\_UDF\_MINITEST]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L65
 [YQL\_UDF\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L150
 [YQL\_UDF\_MODULE\_CONTRIB]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L162
 [YQL\_UDF\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L43
 [YQL\_UDF\_YDB\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L156
 [YT\_UNITTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1421
 [Y\_BENCHMARK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1815
 [ACCELEO]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L5
 [ADDINCL]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [ADDINCLSELF]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3158
 [ADD\_CHECK]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19715103#L771
 [ADD\_CHECK\_PY\_IMPORTS]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19715103#L61
 [ADD\_CLANG\_TIDY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1183
 [ADD\_COMPILABLE\_TRANSLATE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2753
 [ADD\_COMPILABLE\_TRANSLIT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2763
 [ADD\_DLLS\_TO\_JAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2095
 [ADD\_IWYU]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1195
 [ADD\_PYTEST\_BIN]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19715103#L61
 [ADD\_YTEST]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19715103#L1560
 [ALICE\_GENERATE\_FUNCTION\_PROTO\_INCLUDES]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/alice.py?rev=19715103#L85
 [ALICE\_GENERATE\_FUNCTION\_SPECS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/alice.py?rev=19715103#L46
 [ALLOCATOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2651
 [ALLOCATOR\_IMPL]: https://github.com/yandex/yatool/tree/main/build/conf/opensource.conf?rev=19715103#L113
 [ALL\_GO\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L410
 [ALL\_PYTEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1169
 [ALL\_PY\_EXTRA\_LINT\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1189
 [ALL\_PY\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1151
 [ALL\_RESOURCE\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2842
 [ALL\_RESOURCE\_FILES\_FROM\_DIRS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2857
 [ALL\_SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2433
 [ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2029
 [ARCHIVE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4142
 [ARCHIVE\_ASM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4120
 [ARCHIVE\_BY\_KEYS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4153
 [AR\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3396
 [ASM\_PREINCLUDE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5219
 [ASSERT]: https://github.com/yandex/yatool/tree/main/build/plugins/macros_with_error.py?rev=19715103#L28
 [AUTO\_SERVICE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L92
 [BENCHMARK\_OPTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1852
 [BISON\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L57
 [BISON\_GEN\_C]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L64
 [BISON\_GEN\_CPP]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L72
 [BISON\_HEADER]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L94
 [BISON\_NO\_HEADER]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L104
 [BPF]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4988
 [BPF\_STATIC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5002
 [BUILDWITH\_CYTHON\_C]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4026
 [BUILDWITH\_CYTHON\_CPP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3995
 [BUILDWITH\_RAGEL6]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4064
 [BUILD\_CATBOOST]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/other.conf?rev=19715103#L9
 [BUILD\_ONLY\_IF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [BUILD\_YDL\_DESC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3732
 [BUNDLE]: https://github.com/yandex/yatool/tree/main/build/plugins/bundle.py?rev=19715103#L4
 [BUNDLE\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2882
 [CFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4260
 [CGO\_CFLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L461
 [CGO\_LDFLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L470
 [CGO\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L444
 [CHECK\_ALLOWED\_PATH]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/container_layers.py?rev=19715103#L4
 [CHECK\_CONTRIB\_CREDITS]: https://github.com/yandex/yatool/tree/main/build/plugins/credits.py?rev=19715103#L9
 [CHECK\_DEPENDENT\_DIRS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L485
 [CHECK\_JAVA\_DEPS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1791
 [CLANG\_EMIT\_AST\_CXX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4951
 [CLANG\_EMIT\_AST\_CXX\_RUN\_TOOL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5764
 [CLANG\_WARNINGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5733
 [CLEAN\_TEXTREL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2176
 [CMAKE\_EXPORTED\_TARGET\_NAME]: https://github.com/yandex/yatool/tree/main/build/conf/opensource.conf?rev=19715103#L108
 [COLLECT\_CONFIG\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5574
 [COLLECT\_FRONTEND\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5560
 [COLLECT\_GO\_SWAGGER\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L5
 [COLLECT\_JINJA\_TEMPLATES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5453
 [COLLECT\_KOTLIN\_LINT\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/custom_lint.conf?rev=19715103#L43
 [COLLECT\_YAML\_CONFIG\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5567
 [COMPILE\_C\_AS\_CXX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4909
 [COMPILE\_LUA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3655
 [COMPILE\_LUA\_21]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3674
 [COMPILE\_LUA\_OPENRESTY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3692
 [CONFIGURE\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4239
 [CONFTEST\_LOAD\_POLICY\_LEGACY\_GLOBAL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1716
 [CONFTEST\_LOAD\_POLICY\_LOCAL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1704
 [CONLYFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4283
 [COPY]: https://github.com/yandex/yatool/tree/main/build/plugins/cp.py?rev=19715103#L6
 [COPY\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2798
 [COPY\_FILE\_WITH\_CONTEXT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2818
 [COW]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L894
 [CPP\_ADDINCL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5311
 [CPP\_ENUMS\_SERIALIZATION]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19715103#L816
 [CPP\_EVLOG]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L605
 [CPP\_EV\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L283
 [CPP\_PROTOLIBS\_DEBUG\_INFO]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L74
 [CPP\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L273
 [CPP\_PROTO\_PLUGIN0]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L259
 [CPP\_PROTO\_PLUGIN2]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L294
 [CREATE\_BUILDINFO\_FOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4209
 [CREATE\_INIT\_PY\_STRUCTURE]: https://github.com/yandex/yatool/tree/main/build/plugins/create_init_py.py?rev=19715103#L4
 [CREDITS\_DISCLAIMER]: https://github.com/yandex/yatool/tree/main/build/plugins/credits.py?rev=19715103#L4
 [CTEMPLATE\_VARNAMES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4925
 [CUDA\_NVCC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/cuda.conf?rev=19715103#L39
 [CUDA\_SRCS]: https://github.com/yandex/yatool/tree/main/build/plugins/cuda.py?rev=19715103#L13
 [CUSTOM\_LINK\_STEP\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1354
 [CXXFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4290
 [CYTHON\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4297
 [DARWIN\_SIGNED\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5503
 [DARWIN\_STRINGS\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5499
 [DATA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1616
 [DATA\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1642
 [DEB\_VERSION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4536
 [DECIMAL\_MD5\_LOWER\_32\_BITS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4222
 [DECLARE\_EXTERNAL\_HOST\_RESOURCES\_BUNDLE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [DECLARE\_EXTERNAL\_HOST\_RESOURCES\_BUNDLE\_BY\_JSON]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [DECLARE\_EXTERNAL\_HOST\_RESOURCES\_PACK]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [DECLARE\_EXTERNAL\_RESOURCE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [DECLARE\_EXTERNAL\_RESOURCE\_BY\_JSON]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [DECLARE\_IN\_DIRS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4730
 [DEFAULT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [DEFAULT\_JAVA\_SRCS\_LAYOUT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L524
 [DEFAULT\_JDK\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2415
 [DEFAULT\_JUNIT\_JAVA\_SRCS\_LAYOUT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L542
 [DEPENDENCY\_MANAGEMENT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2124
 [DEPENDS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [DIRECT\_DEPS\_ONLY]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2293
 [DISABLE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [DISABLE\_DATA\_VALIDATION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1600
 [DLL\_FOR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [DOCKER\_IMAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1632
 [DOCS\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L327
 [DOCS\_COPY\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L13
 [DOCS\_DIR]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L288
 [DOCS\_HTML\_FROM]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L254
 [DOCS\_INCLUDE\_SOURCES]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L351
 [DOCS\_VARS]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L339
 [DYNAMIC\_LIBRARY\_FROM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2273
 [ELSE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [ELSEIF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [EMBED\_JAVA\_VCS\_INFO]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L413
 [ENABLE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [ENABLE\_PREVIEW]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1993
 [END]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [ENDIF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [ENV]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1685
 [EVLOG\_CMD]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L1071
 [EXCLUDE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2037
 [EXCLUDE\_TAGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [EXPERIMENTAL\_FORK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2987
 [EXPLICIT\_DATA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1652
 [EXPLICIT\_OUTPUTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5130
 [EXPORTS\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1318
 [EXPORT\_ALL\_DYNAMIC\_SYMBOLS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1336
 [EXTERNAL\_RESOURCE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [EXTRADIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [EXTRALIBS\_STATIC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2746
 [FBS\_CMD]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19715103#L153
 [FBS\_NAMESPACE]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19715103#L95
 [FBS\_TO\_PY2SRC]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19715103#L28
 [FILES]: https://github.com/yandex/yatool/tree/main/build/plugins/files.py?rev=19715103#L1
 [FLATC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19715103#L10
 [FLAT\_JOIN\_SRCS\_GLOBAL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3029
 [FLEX\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L50
 [FLEX\_GEN\_C]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L80
 [FLEX\_GEN\_CPP]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L87
 [FORK\_SUBTESTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2949
 [FORK\_TESTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2935
 [FORK\_TEST\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2975
 [FROM\_ARCHIVE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4894
 [FROM\_SANDBOX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4874
 [FULL\_JAVA\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L512
 [FUNCTION\_ORDERING\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L151
 [FUZZ\_DICTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1552
 [FUZZ\_OPTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1571
 [GENERATE\_ENUM\_SERIALIZATION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4515
 [GENERATE\_ENUM\_SERIALIZATION\_WITH\_HEADER]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4527
 [GENERATE\_IMPLIB]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5819
 [GENERATE\_PY\_PROTOS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L671
 [GENERATE\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/plugins/java.py?rev=19715103#L288
 [GENERATE\_YT\_RECORD]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yt.conf?rev=19715103#L7
 [GEN\_SCHEEME2]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4622
 [GLOBAL\_CFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4268
 [GLOBAL\_SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2415
 [GOLANG\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L187
 [GO\_ASM\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L149
 [GO\_BENCH\_TIMEOUT]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1128
 [GO\_CGO1\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L157
 [GO\_CGO2\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L165
 [GO\_COMPILE\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L173
 [GO\_EMBED\_BINDIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L576
 [GO\_EMBED\_DIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L543
 [GO\_EMBED\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L507
 [GO\_EMBED\_TEST\_DIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L551
 [GO\_EMBED\_XTEST\_DIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L559
 [GO\_GRPC\_GATEWAY\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L658
 [GO\_GRPC\_GATEWAY\_SWAGGER\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L666
 [GO\_GRPC\_GATEWAY\_V2\_OPENAPI\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L718
 [GO\_GRPC\_GATEWAY\_V2\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L736
 [GO\_LDFLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L453
 [GO\_LINK\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L181
 [GO\_MOCKGEN\_CONTRIB\_FROM]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1207
 [GO\_MOCKGEN\_FROM]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1197
 [GO\_MOCKGEN\_MOCKS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1258
 [GO\_MOCKGEN\_PACKAGE]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1223
 [GO\_MOCKGEN\_REFLECT]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1232
 [GO\_MOCKGEN\_SOURCE]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1287
 [GO\_MOCKGEN\_TYPES]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1213
 [GO\_OAPI\_CODEGEN]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1303
 [GO\_OAPI\_CODEGEN\_TAXI]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1326
 [GO\_OAPI\_CODEGEN\_TAXI\_1134]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1332
 [GO\_OAPI\_CODEGEN\_V2]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L1320
 [GO\_PACKAGE\_NAME]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L385
 [GO\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L412
 [GO\_PROTO\_USE\_V2]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L648
 [GO\_SKIP\_TESTS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L481
 [GO\_SSO]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L219
 [GO\_SSO\_TOOL]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L232
 [GO\_TEST\_EMBED\_BINDIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L584
 [GO\_TEST\_EMBED\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L515
 [GO\_TEST\_FOR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [GO\_TEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L420
 [GO\_XTEST\_EMBED\_BINDIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L592
 [GO\_XTEST\_EMBED\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L523
 [GO\_XTEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19715103#L430
 [GRPC]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L620
 [GRPC\_WITH\_GMOCK]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L641
 [HEADERS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5743
 [IDEA\_EXCLUDE\_DIRS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1950
 [IDEA\_MODULE\_NAME]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1970
 [IDEA\_RESOURCE\_DIRS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1960
 [IF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [INCLUDE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [INCLUDE\_ONCE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [INCLUDE\_TAGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [INDUCED\_DEPS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [INJECT\_PEERS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/node_modules.conf?rev=19715103#L84
 [IOS\_APP\_ASSETS\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5495
 [IOS\_APP\_COMMON\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5489
 [IOS\_APP\_SETTINGS]: https://github.com/yandex/yatool/tree/main/build/plugins/ios_app_settings.py?rev=19715103#L5
 [IOS\_ASSETS]: https://github.com/yandex/yatool/tree/main/build/plugins/ios_assets.py?rev=19715103#L6
 [IWYU\_MAPPING\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4481
 [JAR\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L599
 [JAR\_EXCLUDE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2344
 [JAR\_MAIN\_CLASS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1102
 [JAR\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L693
 [JAVAC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1981
 [JAVA\_DEPENDENCIES\_CONFIGURATION]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2333
 [JAVA\_EXTERNAL\_DEPENDENCIES]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2302
 [JAVA\_IGNORE\_CLASSPATH\_CLASH\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L571
 [JAVA\_MODULE]: https://github.com/yandex/yatool/tree/main/build/plugins/java.py?rev=19715103#L41
 [JAVA\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L217
 [JAVA\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L996
 [JAVA\_RESOURCE\_TAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2086
 [JAVA\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2074
 [JAVA\_TEST]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19715103#L61
 [JAVA\_TEST\_DEPS]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19715103#L61
 [JDK\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2407
 [JNI\_EXPORTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1322
 [JOIN\_SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3008
 [JOIN\_SRCS\_GLOBAL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3019
 [JUNIT\_TESTS\_JAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L152
 [JVM\_ARGS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1780
 [KAPT\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L819
 [KAPT\_ANNOTATION\_PROCESSOR\_CLASSPATH]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L827
 [KAPT\_ANNOTATION\_PROCESSOR\_OPTIONS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L837
 [KAPT\_OPTS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L811
 [KOTLINC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2179
 [KTLINT\_BASELINE\_FILE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2442
 [KTLINT\_RULESET]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2450
 [LARGE\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4885
 [LDFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4250
 [LD\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3405
 [LICENSE]: https://github.com/yandex/yatool/tree/main/build/conf/license.conf?rev=19715103#L26
 [LICENSE\_RESTRICTION]: https://github.com/yandex/yatool/tree/main/build/conf/license.conf?rev=19715103#L43
 [LICENSE\_RESTRICTION\_EXCEPTIONS]: https://github.com/yandex/yatool/tree/main/build/conf/license.conf?rev=19715103#L66
 [LICENSE\_TEXTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5671
 [LINKER\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/plugins/linker_script.py?rev=19715103#L1
 [LINK\_EXCLUDE\_LIBRARIES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5803
 [LINT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1767
 [LIST\_PROTO]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L699
 [LJ\_21\_ARCHIVE]: https://github.com/yandex/yatool/tree/main/build/plugins/lj_archive.py?rev=19715103#L25
 [LJ\_ARCHIVE]: https://github.com/yandex/yatool/tree/main/build/plugins/lj_archive.py?rev=19715103#L1
 [LLVM\_BC]: https://github.com/yandex/yatool/tree/main/build/plugins/llvm_bc.py?rev=19715103#L4
 [LLVM\_COMPILE\_C]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4974
 [LLVM\_COMPILE\_CXX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4960
 [LLVM\_COMPILE\_LL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5011
 [LLVM\_LINK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5021
 [LLVM\_LLC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5042
 [LLVM\_OPT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5031
 [LOCAL\_JAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L703
 [LOCAL\_SOURCES\_JAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L708
 [MACROS\_WITH\_ERROR]: https://github.com/yandex/yatool/tree/main/build/plugins/macros_with_error.py?rev=19715103#L8
 [MANUAL\_GENERATION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3372
 [MASMFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4275
 [MAVEN\_GROUP\_ID]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2018
 [MESSAGE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [MODULEWISE\_LICENSE\_RESTRICTION]: https://github.com/yandex/yatool/tree/main/build/conf/license.conf?rev=19715103#L58
 [NEED\_CHECK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4545
 [NEED\_REVIEW]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4563
 [NGINX\_MODULES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5648
 [NO\_BUILD\_IF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [NO\_CHECK\_IMPORTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5139
 [NO\_CLANG\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4453
 [NO\_CLANG\_MCDC\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4461
 [NO\_CLANG\_TIDY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4473
 [NO\_COMPILER\_WARNINGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4326
 [NO\_COW]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L898
 [NO\_CPU\_CHECK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3151
 [NO\_CUDA\_NVPRUNE]: https://github.com/yandex/yatool/tree/main/build/conf/cuda.conf?rev=19715103#L152
 [NO\_CYTHON\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1094
 [NO\_DEBUG\_INFO]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4916
 [NO\_DOCTESTS]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L420
 [NO\_EXPORT\_DYNAMIC\_SYMBOLS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1329
 [NO\_EXTENDED\_SOURCE\_SEARCH]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L335
 [NO\_IMPORT\_TRACING]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1085
 [NO\_IWYU]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4488
 [NO\_JOIN\_SRC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4425
 [NO\_LIBC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4379
 [NO\_LINT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1760
 [NO\_LTO]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L400
 [NO\_MYPY]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L510
 [NO\_NEED\_CHECK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4554
 [NO\_OPTIMIZE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4317
 [NO\_OPTIMIZE\_PY\_PROTOS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L164
 [NO\_PLATFORM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4390
 [NO\_PROFILE\_RUNTIME]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4469
 [NO\_PYTHON\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1077
 [NO\_RUNTIME]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4368
 [NO\_SANITIZE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4433
 [NO\_SANITIZE\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4445
 [NO\_SPLIT\_DWARF]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2731
 [NO\_SSE4]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3143
 [NO\_TS\_TYPECHECK]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L295
 [NO\_UTIL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4357
 [NO\_WSHADOW]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4333
 [NO\_YMAKE\_PYTHON3]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L269
 [NVCC\_DEVICE\_LINK]: https://github.com/yandex/yatool/tree/main/build/conf/cuda.conf?rev=19715103#L143
 [OBJC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4304
 [ONLY\_TAGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [OPENSOURCE\_EXPORT\_REPLACEMENT]: https://github.com/yandex/yatool/tree/main/build/conf/opensource.conf?rev=19715103#L83
 [OPENSOURCE\_EXPORT\_REPLACEMENT\_BY\_OS]: https://github.com/yandex/yatool/tree/main/build/conf/opensource.conf?rev=19715103#L92
 [ORIGINAL\_SOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5658
 [PACK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2459
 [PARALLEL\_TESTS\_WITHIN\_NODE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2918
 [PARTITIONED\_RECURSE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [PARTITIONED\_RECURSE\_FOR\_TESTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [PARTITIONED\_RECURSE\_ROOT\_RELATIVE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [PEERDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [PIRE\_INLINE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4131
 [PIRE\_INLINE\_CMD]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4126
 [POPULATE\_CPP\_COVERAGE\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/coverage_full_instrumentation.conf?rev=19715103#L7
 [POPULATE\_CPP\_YNDEXING]: https://github.com/yandex/yatool/tree/main/build/conf/yndexing/cpp_instrumentation.conf?rev=19715103#L6
 [PREPARE\_INDUCED\_DEPS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4656
 [PROCESSOR\_CLASSES]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L88
 [PROCESS\_DOCS]: https://github.com/yandex/yatool/tree/main/build/plugins/docs.py?rev=19715103#L39
 [PROCESS\_MKDOCS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/mkdocs.py?rev=19715103#L35
 [PROTO2FBS]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19715103#L162
 [PROTOC\_FATAL\_WARNINGS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L144
 [PROTO\_ADDINCL]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L117
 [PROTO\_CMD]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L1076
 [PROTO\_NAMESPACE]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L134
 [PROTO\_TO\_NAMESPACE]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sdc_proto.py?rev=19715103#L11
 [PROVIDES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [PYTHON2\_ADDINCL]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L944
 [PYTHON2\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L631
 [PYTHON3\_ADDINCL]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L993
 [PYTHON3\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L643
 [PYTHON\_PATH]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1740
 [PY\_CONSTRUCTOR]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19715103#L784
 [PY\_DOCTESTS]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19715103#L698
 [PY\_ENUMS\_SERIALIZATION]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19715103#L799
 [PY\_EXTRALIBS]: https://github.com/yandex/yatool/tree/main/build/plugins/extralibs.py?rev=19715103#L1
 [PY\_EXTRA\_LINT\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1199
 [PY\_MAIN]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19715103#L762
 [PY\_NAMESPACE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L680
 [PY\_PROTOS\_FOR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [PY\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L189
 [PY\_PROTO\_PLUGIN2]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L201
 [PY\_REGISTER]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19715103#L716
 [PY\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1125
 [RECURSE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [RECURSE\_FOR\_TESTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [RECURSE\_ROOT\_RELATIVE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [REGISTER\_SANDBOX\_IMPORT]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sandbox_registry.py?rev=19715103#L6
 [REGISTER\_YQL\_PYTHON\_UDF]: https://github.com/yandex/yatool/tree/main/build/plugins/yql_python_udf.py?rev=19715103#L11
 [REQUIREMENTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1675
 [REQUIRES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L463
 [REQUIRE\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1627
 [RESOLVE\_PROTO]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L661
 [RESOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L522
 [RESOURCE\_FILES]: https://github.com/yandex/yatool/tree/main/build/plugins/res.py?rev=19715103#L12
 [RESTRICT\_PATH]: https://github.com/yandex/yatool/tree/main/build/plugins/macros_with_error.py?rev=19715103#L13
 [RISK\_GEN\_DATA\_MODEL]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/fintech_risk_model.py?rev=19715103#L276
 [ROS\_SRCS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/ros.py?rev=19715103#L5
 [RUN]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19715103#L990
 [RUN\_ANTLR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5226
 [RUN\_ANTLR4]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5246
 [RUN\_ANTLR4\_CPP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5270
 [RUN\_ANTLR4\_CPP\_SPLIT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5260
 [RUN\_ANTLR4\_GO]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5280
 [RUN\_ANTLR4\_PYTHON2]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5293
 [RUN\_ANTLR4\_PYTHON3]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5306
 [RUN\_JAVASCRIPT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L267
 [RUN\_JAVASCRIPT\_AFTER\_BUILD]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L252
 [RUN\_JAVA\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L591
 [RUN\_LUA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4786
 [RUN\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4760
 [RUN\_PY3\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4840
 [RUN\_PYTHON3]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4812
 [SDBUS\_CPP\_ADAPTOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5627
 [SDBUS\_CPP\_PROXY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5633
 [SDC\_DIAGS\_SPLIT\_GENERATOR\_V3]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sdc_diagnostics.py?rev=19715103#L59
 [SDC\_DIAGS\_SPLIT\_GENERATOR\_V4]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sdc_diagnostics.py?rev=19715103#L23
 [SDC\_INSTALL]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sdc.py?rev=19715103#L59
 [SELECT\_CLANG\_SA\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L167
 [SELECT\_PROTO\_LAYOUT]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L82
 [SET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [SETUP\_EXECTEST]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19715103#L61
 [SETUP\_PYTEST\_BIN]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19715103#L983
 [SETUP\_RUN\_PYTHON]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19715103#L1035
 [SET\_APPEND]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [SET\_APPEND\_WITH\_GLOBAL]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [SET\_COMPILE\_OUTPUTS\_MODIFIERS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3171
 [SET\_CPP\_COVERAGE\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/plugins/coverage.py?rev=19715103#L42
 [SET\_CUSTOM\_CLANG\_TIDY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1187
 [SET\_RESOURCE\_MAP\_FROM\_JSON]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [SET\_RESOURCE\_URI\_FROM\_JSON]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [SIZE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2999
 [SKIP\_TEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1749
 [SOURCE\_GROUP]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [SPLIT\_CODEGEN]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/split_codegen.py?rev=19715103#L9
 [SPLIT\_DWARF]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2723
 [SPLIT\_FACTOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2963
 [SRC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3758
 [SRCDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19715103#L16
 [SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3777
 [SRC\_C\_AMX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3912
 [SRC\_C\_AVX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3888
 [SRC\_C\_AVX2]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3896
 [SRC\_C\_AVX512]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3904
 [SRC\_C\_NO\_LTO]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3986
 [SRC\_C\_PIC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3978
 [SRC\_C\_SSE2]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3848
 [SRC\_C\_SSE3]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3856
 [SRC\_C\_SSE4]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3872
 [SRC\_C\_SSE41]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3880
 [SRC\_C\_SSSE3]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3864
 [SRC\_C\_XOP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3921
 [SRC\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L698
 [STRIP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4311
 [STYLE\_CPP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5719
 [STYLE\_DETEKT]: https://github.com/yandex/yatool/tree/main/build/conf/custom_lint.conf?rev=19715103#L52
 [STYLE\_DUMMY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L376
 [STYLE\_FLAKE8]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L404
 [STYLE\_JSON]: https://github.com/yandex/yatool/tree/main/build/conf/custom_lint.conf?rev=19715103#L13
 [STYLE\_PY2\_FLAKE8]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L412
 [STYLE\_PYTHON]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L384
 [STYLE\_RUFF]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L395
 [STYLE\_YAML]: https://github.com/yandex/yatool/tree/main/build/conf/custom_lint.conf?rev=19715103#L23
 [STYLE\_YQL]: https://github.com/yandex/yatool/tree/main/build/conf/custom_lint.conf?rev=19715103#L33
 [SUBSCRIBER]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4577
 [SUPPRESSIONS]: https://github.com/yandex/yatool/tree/main/build/plugins/suppressions.py?rev=19715103#L1
 [SYMLINK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4628
 [SYSTEM\_PROPERTIES]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1768
 [TAG]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1664
 [TASKLET]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5325
 [TASKLET\_REG]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5342
 [TASKLET\_REG\_EXT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5357
 [TEST\_CWD]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2603
 [TEST\_DATA]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19715103#L118
 [TEST\_JAVA\_CLASSPATH\_CMD\_TYPE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2316
 [TEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1596
 [THINLTO\_CACHE]: https://github.com/yandex/yatool/tree/main/build/conf/linkers/ld.conf?rev=19715103#L434
 [TIMEOUT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2891
 [TOOLCHAIN]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5777
 [TS\_BIOME]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L365
 [TS\_BUILD\_ENV]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L276
 [TS\_BUILD\_OUTPUTS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_library.conf?rev=19715103#L65
 [TS\_BUILD\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_library.conf?rev=19715103#L61
 [TS\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L36
 [TS\_ESLINT\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L143
 [TS\_EXCLUDE\_FILES\_GLOB]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L101
 [TS\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L219
 [TS\_FILES\_GLOB]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L228
 [TS\_LARGE\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L242
 [TS\_LINT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_check.conf?rev=19715103#L8
 [TS\_NEXT\_BUILD\_OPTIONS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19715103#L22
 [TS\_NEXT\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19715103#L11
 [TS\_NEXT\_EXPERIMENTAL\_BUILD\_MODE]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19715103#L45
 [TS\_NEXT\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19715103#L35
 [TS\_PROTO\_OPT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_proto.conf?rev=19715103#L88
 [TS\_PROTO\_PACKAGE\_NAME]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_proto.conf?rev=19715103#L103
 [TS\_RSPACK\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_rspack.conf?rev=19715103#L10
 [TS\_RSPACK\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_rspack.conf?rev=19715103#L22
 [TS\_STYLELINT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L339
 [TS\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_check.conf?rev=19715103#L12
 [TS\_TEST\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L229
 [TS\_TEST\_DATA]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L270
 [TS\_TEST\_DEPENDS\_ON\_BUILD]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L279
 [TS\_TEST\_INCLUDE\_NODEJS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L286
 [TS\_TEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L247
 [TS\_TYPECHECK]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19715103#L316
 [TS\_USE\_BUN]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19715103#L283
 [TS\_VITE\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_vite.conf?rev=19715103#L10
 [TS\_VITE\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_vite.conf?rev=19715103#L24
 [TS\_WEBPACK\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_webpack.conf?rev=19715103#L10
 [TS\_WEBPACK\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_webpack.conf?rev=19715103#L22
 [UBERJAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1826
 [UBERJAR\_APPENDING\_TRANSFORMER]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1926
 [UBERJAR\_HIDE\_EXCLUDE\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1855
 [UBERJAR\_HIDE\_INCLUDE\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1870
 [UBERJAR\_HIDING\_PREFIX]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1840
 [UBERJAR\_MANIFEST\_TRANSFORMER\_ATTRIBUTE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1910
 [UBERJAR\_MANIFEST\_TRANSFORMER\_MAIN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1897
 [UBERJAR\_PATH\_EXCLUDE\_PREFIX]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1884
 [UBERJAR\_SERVICES\_RESOURCE\_TRANSFORMER]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1939
 [UDF\_NO\_PROBE]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L26
 [UDF\_NO\_SCAN]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L33
 [UPDATE\_VCS\_JAVA\_INFO\_NODEP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4182
 [USE\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L620
 [USE\_COMMON\_GOOGLE\_APIS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L363
 [USE\_CXX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4400
 [USE\_DYNAMIC\_CUDA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1344
 [USE\_ERROR\_PRONE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L1800
 [USE\_JAVALITE]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L537
 [USE\_KTLINT\_OLD]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2432
 [USE\_LEGACY\_PNPM\_VIRTUAL\_STORE]: https://github.com/yandex/yatool/tree/main/build/conf/ts/node_modules.conf?rev=19715103#L80
 [USE\_LINKER\_GOLD]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L881
 [USE\_LLVM\_BC16]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4932
 [USE\_LLVM\_BC18]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4937
 [USE\_LLVM\_BC20]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4942
 [USE\_MODERN\_FLEX]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L112
 [USE\_MODERN\_FLEX\_WITH\_HEADER]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L123
 [USE\_NASM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4417
 [USE\_OLD\_FLEX]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19715103#L132
 [USE\_PLANTUML]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19715103#L275
 [USE\_PYTHON2]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1046
 [USE\_PYTHON3]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19715103#L1063
 [USE\_RECIPE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1728
 [USE\_SA\_PLUGINS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L176
 [USE\_SKIFF]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L305
 [USE\_UTIL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4408
 [USRV\_GEN\_GRPC\_CLIENT\_V2]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19715103#L338
 [USRV\_GEN\_GRPC\_CLIENT\_V2\_STRUCTS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19715103#L342
 [USRV\_GEN\_GRPC\_SERVICE\_V2]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19715103#L346
 [USRV\_GEN\_GRPC\_SERVICE\_V2\_STRUCTS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19715103#L350
 [USRV\_GEN\_PROTO\_STRUCTS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19715103#L319
 [VALIDATE\_DATA\_RESTART]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L2901
 [VALIDATE\_IN\_DIRS]: https://github.com/yandex/yatool/tree/main/build/plugins/macros_with_error.py?rev=19715103#L35
 [VCS\_INFO\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4196
 [VERSION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L4585
 [VISIBILITY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5605
 [VITE\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_vite.conf?rev=19715103#L30
 [WEBPACK\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_webpack.conf?rev=19715103#L28
 [WINDOWS\_LONG\_PATH\_MANIFEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5590
 [WINDOWS\_MANIFEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5585
 [WITHOUT\_LICENSE\_TEXTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5679
 [WITHOUT\_VERSION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5781
 [WITH\_DYNAMIC\_LIBS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1074
 [WITH\_JDK]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2134
 [WITH\_KAPT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2165
 [WITH\_KOTLIN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2153
 [WITH\_KOTLINC\_ALLOPEN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2197
 [WITH\_KOTLINC\_DETEKT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2243
 [WITH\_KOTLINC\_LOMBOK]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2208
 [WITH\_KOTLINC\_NOARG]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2220
 [WITH\_KOTLINC\_SERIALIZATION]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2232
 [WITH\_KOTLIN\_GRPC]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L231
 [WITH\_NODE\_MODULES]: https://github.com/yandex/yatool/tree/main/build/conf/ts/node_modules.conf?rev=19715103#L27
 [WITH\_YA\_1931]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19715103#L2460
 [YABS\_GENERATE\_CONF]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/yabs_generate_conf.py?rev=19715103#L10
 [YABS\_GENERATE\_PHANTOM\_CONF\_PATCH]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/yabs_generate_conf.py?rev=19715103#L41
 [YABS\_GENERATE\_PHANTOM\_CONF\_TEST\_CHECK]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/yabs_generate_conf.py?rev=19715103#L51
 [YA\_CONF\_JSON]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L5700
 [YDL\_DESC\_USE\_BINARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L3749
 [YQL\_ABI\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L249
 [YQL\_LAST\_ABI\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19715103#L258
 [YT\_ORM\_PROTO\_YSON]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19715103#L446
 [YT\_RECORD\_DISABLE\_PEERDIR]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yt.conf?rev=19715103#L3
 [YT\_SPEC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19715103#L1585
 [ALIASES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L31
 [ALLOWED]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L34
 [ALLOWED\_IN\_LINTERS\_MAKE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L35
 [ARGS\_PARSER]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L43
 [CMD]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L44
 [DEFAULT\_NAME\_GENERATOR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L45
 [EPILOGUE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L46
 [EXTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L47
 [FILE\_GROUP]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L91
 [FINAL\_TARGET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L50
 [GEN\_FROM\_FILE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L53
 [GLOBAL]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L56
 [GLOBAL\_CMD]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L57
 [GLOBAL\_EXTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L60
 [GLOBAL\_SEM]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L61
 [IGNORED]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L64
 [INCLUDE\_TAG]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L67
 [NODE\_TYPE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L70
 [NO\_EXPAND]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L73
 [PEERDIRSELF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L80
 [PEERDIR\_POLICY]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L77
 [PROXY]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L81
 [RESTRICTED]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L87
 [SEM]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L88
 [SYMLINK\_POLICY]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L89
 [TRANSITION]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L94
 [USE\_PEERS\_LATE\_OUTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L90
 [VERSION\_PROXY]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19715103#L84
 [APPLIED\_EXCLUDES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L23
 [ARCADIA\_BUILD\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L24
 [ARCADIA\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L25
 [AUTO\_INPUT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L26
 [BINDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L27
 [CMAKE\_CURRENT\_BINARY\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L29
 [CMAKE\_CURRENT\_SOURCE\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L30
 [CONSUME\_NON\_MANAGEABLE\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L31
 [CURDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L32
 [DART\_CLASSPATH]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L34
 [DART\_CLASSPATH\_DEPS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L33
 [DEFAULT\_MODULE\_LICENSE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L35
 [DEPENDENCY\_MANAGEMENT\_TAGS\_EXCLUDE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L37
 [DEPENDENCY\_MANAGEMENT\_TRANSPARENT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L38
 [DEPENDENCY\_MANAGEMENT\_VALUE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L36
 [DONT\_RESOLVE\_INCLUDES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L39
 [DYNAMIC\_LINK]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L40
 [EV\_HEADER\_EXTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L41
 [EXCLUDE\_SUBMODULES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L42
 [EXCLUDE\_VALUE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L43
 [EXPORTED\_BUILD\_SYSTEM\_BUILD\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L44
 [EXPORTED\_BUILD\_SYSTEM\_SOURCE\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L45
 [GLOBAL\_SUFFIX]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L47
 [GLOBAL\_TARGET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L48
 [GO\_TEST\_FOR\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L50
 [HAS\_MANAGEABLE\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L51
 [IGNORE\_JAVA\_DEPENDENCIES\_CONFIGURATION]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L52
 [INPUT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L53
 [JAVA\_DEPENDENCIES\_CONFIGURATION\_VALUE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L55
 [MANAGED\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L57
 [MANAGED\_PEERS\_CLOSURE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L56
 [MANGLED\_MODULE\_TYPE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L58
 [MODDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L59
 [MODULE\_ARGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L60
 [MODULE\_COMMON\_CONFIGS\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L61
 [MODULE\_KIND]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L62
 [MODULE\_LANG]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L63
 [MODULE\_PREFIX]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L64
 [MODULE\_SEM\_IGNORE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L70
 [MODULE\_SUFFIX]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L65
 [MODULE\_TYPE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L69
 [NON\_NAMAGEABLE\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L72
 [OUTPUT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L73
 [PASS\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L76
 [PEERDIR\_TAGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L77
 [PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L79
 [PEERS\_LATE\_OUTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L78
 [PROTO\_HEADER\_EXTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L80
 [PYTHON\_BIN]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L81
 [REALPRJNAME]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L82
 [SONAME]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L83
 [SRCS\_GLOBAL]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L85
 [START\_TARGET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L86
 [TARGET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L87
 [TEST\_CASE\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L88
 [TEST\_OUT\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L89
 [TEST\_SOURCE\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L90
 [TEST\_WORK\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L91
 [TOOLS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L92
 [TS\_CONFIG\_DECLARATION]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L94
 [TS\_CONFIG\_DECLARATION\_MAP]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L93
 [TS\_CONFIG\_DEDUCE\_OUT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L95
 [TS\_CONFIG\_OUT\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L96
 [TS\_CONFIG\_PRESERVE\_JSX]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L97
 [TS\_CONFIG\_ROOT\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L98
 [TS\_CONFIG\_SOURCE\_MAP]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L99
 [UNITTEST\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L100
 [UNITTEST\_MOD]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L101
 [USE\_ALL\_SRCS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L102
 [USE\_GLOBAL\_CMD]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19715103#L103
