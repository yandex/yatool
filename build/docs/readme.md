...
## Table of contents
   ...
   * [Macros](#macros)
       ...
       - Macros [COLLECT_FRONTEND_FILES](#macro_COLLECT_FRONTEND_FILES) .. [CONFTEST_LOAD_POLICY_LEGACY_GLOBAL](#macro_CONFTEST_LOAD_POLICY_LEGACY_GLOBAL)
       - Macros [CONFTEST_LOAD_POLICY_LOCAL](#macro_CONFTEST_LOAD_POLICY_LOCAL) .. [CPP_EV_PROTO_PLUGIN](#macro_CPP_EV_PROTO_PLUGIN)
       - Macros [CPP_PROTOLIBS_DEBUG_INFO](#macro_CPP_PROTOLIBS_DEBUG_INFO) .. [CUDA_SRCS](#macro_CUDA_SRCS)
       ...
       - Macros [DEPENDS](#macro_DEPENDS) .. [DOCS_HTML_FROM](#macro_DOCS_HTML_FROM)
       - Macros [DOCS_INCLUDE_SOURCES](#macro_DOCS_INCLUDE_SOURCES) .. [ENDIF](#macro_ENDIF)
       - Macros [ENV](#macro_ENV) .. [EXTERNAL_RESOURCE](#macro_EXTERNAL_RESOURCE)
       - Macros [EXTRADIR](#macro_EXTRADIR) .. [FLEX_GEN_C](#macro_FLEX_GEN_C)
       - Macros [FLEX_GEN_CPP](#macro_FLEX_GEN_CPP) .. [FUZZ_OPTS](#macro_FUZZ_OPTS)
       - Macros [GENERATE_ENUM_SERIALIZATION](#macro_GENERATE_ENUM_SERIALIZATION) .. [GOLANG_VERSION](#macro_GOLANG_VERSION)
       - Macros [GO_ASM_FLAGS](#macro_GO_ASM_FLAGS) .. [GO_EMBED_XTEST_DIR](#macro_GO_EMBED_XTEST_DIR)
       - Macros [GO_GRPC_GATEWAY_SRCS](#macro_GO_GRPC_GATEWAY_SRCS) .. [GO_MOCKGEN_PACKAGE](#macro_GO_MOCKGEN_PACKAGE)
       - Macros [GO_MOCKGEN_REFLECT](#macro_GO_MOCKGEN_REFLECT) .. [GO_PROTO_USE_V2](#macro_GO_PROTO_USE_V2)
       - Macros [GO_SKIP_TESTS](#macro_GO_SKIP_TESTS) .. [GO_XTEST_SRCS](#macro_GO_XTEST_SRCS)
       - Macros [GRPC](#macro_GRPC) .. [INCLUDE_TAGS](#macro_INCLUDE_TAGS)
       - Macros [INDUCED_DEPS](#macro_INDUCED_DEPS) .. [JAR_MAIN_CLASS](#macro_JAR_MAIN_CLASS)
       - Macros [JAR_RESOURCE](#macro_JAR_RESOURCE) .. [JAVA_SRCS](#macro_JAVA_SRCS)
       - Macros [JAVA_TEST](#macro_JAVA_TEST) .. [KAPT_ANNOTATION_PROCESSOR_CLASSPATH](#macro_KAPT_ANNOTATION_PROCESSOR_CLASSPATH)
       - Macros [KAPT_ANNOTATION_PROCESSOR_OPTIONS](#macro_KAPT_ANNOTATION_PROCESSOR_OPTIONS) .. [LICENSE_RESTRICTION](#macro_LICENSE_RESTRICTION)
       - Macros [LICENSE_RESTRICTION_EXCEPTIONS](#macro_LICENSE_RESTRICTION_EXCEPTIONS) .. [LLVM_COMPILE_C](#macro_LLVM_COMPILE_C)
       - Macros [LLVM_COMPILE_CXX](#macro_LLVM_COMPILE_CXX) .. [MASMFLAGS](#macro_MASMFLAGS)
       - Macros [MAVEN_GROUP_ID](#macro_MAVEN_GROUP_ID) .. [NO_CLANG_MCDC_COVERAGE](#macro_NO_CLANG_MCDC_COVERAGE)
       - Macros [NO_CLANG_TIDY](#macro_NO_CLANG_TIDY) .. [NO_EXTENDED_SOURCE_SEARCH](#macro_NO_EXTENDED_SOURCE_SEARCH)
       - Macros [NO_IMPORT_TRACING](#macro_NO_IMPORT_TRACING) .. [NO_OPTIMIZE_PY_PROTOS](#macro_NO_OPTIMIZE_PY_PROTOS)
       - Macros [NO_PLATFORM](#macro_NO_PLATFORM) .. [NO_UTIL](#macro_NO_UTIL)
       - Macros [NO_WSHADOW](#macro_NO_WSHADOW) .. [PARALLEL_TESTS_WITHIN_NODE](#macro_PARALLEL_TESTS_WITHIN_NODE)
       - Macros [PARTITIONED_RECURSE](#macro_PARTITIONED_RECURSE) .. [PROCESSOR_CLASSES](#macro_PROCESSOR_CLASSES)
       - Macros [PROCESS_DOCS](#macro_PROCESS_DOCS) .. [PYTHON2_ADDINCL](#macro_PYTHON2_ADDINCL)
       - Macros [PYTHON2_MODULE](#macro_PYTHON2_MODULE) .. [PY_MAIN](#macro_PY_MAIN)
       - Macros [PY_NAMESPACE](#macro_PY_NAMESPACE) .. [REGISTER_SANDBOX_IMPORT](#macro_REGISTER_SANDBOX_IMPORT)
       - Macros [REGISTER_YQL_PYTHON_UDF](#macro_REGISTER_YQL_PYTHON_UDF) .. [ROS_SRCS](#macro_ROS_SRCS)
       - Macros [RUN](#macro_RUN) .. [RUN_JAVASCRIPT_AFTER_BUILD](#macro_RUN_JAVASCRIPT_AFTER_BUILD)
       - Macros [RUN_JAVA_PROGRAM](#macro_RUN_JAVA_PROGRAM) .. [SDC_INSTALL](#macro_SDC_INSTALL)
       - Macros [SELECT_CLANG_SA_CONFIG](#macro_SELECT_CLANG_SA_CONFIG) .. [SET_CPP_COVERAGE_FLAGS](#macro_SET_CPP_COVERAGE_FLAGS)
       - Macros [SET_RESOURCE_MAP_FROM_JSON](#macro_SET_RESOURCE_MAP_FROM_JSON) .. [SRCDIR](#macro_SRCDIR)
       - Macros [SRCS](#macro_SRCS) .. [SRC_C_SSE4](#macro_SRC_C_SSE4)
       - Macros [SRC_C_SSE41](#macro_SRC_C_SSE41) .. [STYLE_PY2_FLAKE8](#macro_STYLE_PY2_FLAKE8)
       - Macros [STYLE_PYTHON](#macro_STYLE_PYTHON) .. [TASKLET](#macro_TASKLET)
       - Macros [TASKLET_REG](#macro_TASKLET_REG) .. [TS_BIOME](#macro_TS_BIOME)
       - Macros [TS_BUILD_ENV](#macro_TS_BUILD_ENV) .. [TS_LINT](#macro_TS_LINT)
       - Macros [TS_NEXT_BUILD_OPTIONS](#macro_TS_NEXT_BUILD_OPTIONS) .. [TS_TEST](#macro_TS_TEST)
       - Macros [TS_TEST_CONFIG](#macro_TS_TEST_CONFIG) .. [TS_WEBPACK_OUTPUT](#macro_TS_WEBPACK_OUTPUT)
       - Macros [UBERJAR](#macro_UBERJAR) .. [UDF_NO_PROBE](#macro_UDF_NO_PROBE)
       - Macros [UDF_NO_SCAN](#macro_UDF_NO_SCAN) .. [USE_LEGACY_PNPM_VIRTUAL_STORE](#macro_USE_LEGACY_PNPM_VIRTUAL_STORE)
       - Macros [USE_LINKER_GOLD](#macro_USE_LINKER_GOLD) .. [USE_PYTHON2](#macro_USE_PYTHON2)
       - Macros [USE_PYTHON3](#macro_USE_PYTHON3) .. [USRV_GEN_PROTO_STRUCTS](#macro_USRV_GEN_PROTO_STRUCTS)
       ...
       - Macros [WITH_KOTLIN_GRPC](#macro_WITH_KOTLIN_GRPC) .. [YQL_LAST_ABI_VERSION](#macro_YQL_LAST_ABI_VERSION)
...
Not documented yet.
 ...
 [DLL\_JAVA]: https://github.com/yandex/yatool/tree/main/build/conf/swig.conf?rev=19325788#L90
 [DOCS]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L155
 [FBS\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19325788#L113
 [JAVA\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L106
 [JAVA\_CONTRIB\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L124
 [JAVA\_CONTRIB\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L378
 [JAVA\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L60
 [JTEST]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L281
 [JTEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L339
 [JUNIT5]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L221
 [JUNIT6]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L161
 [PACKAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2473
 [PROTO\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L916
 [PROTO\_SCHEMA]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L1003
 [PY23\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1210
 [PY23\_NATIVE\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1236
 [PY23\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1262
 [PY3TEST]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L515
 [PY3\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L347
 [TS\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_library.conf?rev=19325788#L31
 [TS\_NEXT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19325788#L73
 [TS\_PACKAGE]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_package.conf?rev=19325788#L35
 [TS\_RSPACK]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_rspack.conf?rev=19325788#L48
 [TS\_TEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_check.conf?rev=19325788#L16
 [TS\_TSC]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_tsc.conf?rev=19325788#L21
 [TS\_VITE]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_vite.conf?rev=19325788#L57
 [TS\_WEBPACK]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_webpack.conf?rev=19325788#L55
 [YQL\_UDF]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L162
 [YQL\_UDF\_CONTRIB]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L204
 [YQL\_UDF\_YDB]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L183
 [BOOSTTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1496
 [BOOSTTEST\_WITH\_MAIN]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1518
 [CI\_GROUP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2502
 [CUDA\_DEVICE\_LINK\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/cuda.conf?rev=19325788#L132
 [DEFAULT\_IOS\_INTERFACE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5501
 [DLL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2264
 [DLL\_TOOL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2281
 [DOCS\_HTML]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L236
 [DOCS\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L88
 [EXECTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1773
 [FAT\_OBJECT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2062
 [FUZZ]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1452
 [GEN\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L590
 [GO\_DLL]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1101
 [GO\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L975
 [GO\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L992
 [GO\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1121
 [GTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1428
 [G\_BENCHMARK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1811
 [IOS\_INTERFACE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5490
 [JAVA\_CONTRIB]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L724
 [JAVA\_CONTRIB\_PROXY]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L668
 [JAVA\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L15
 [JAVA\_TEST\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L19
 [LIBRARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1946
 [PROGRAM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1279
 [PROTO\_DESCRIPTIONS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L975
 [PROTO\_REGISTRY]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L988
 [PY2MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L602
 [PY2TEST]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L463
 [PY2\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L693
 [PY2\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L315
 [PY3MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L621
 [PY3TEST\_BIN]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L486
 [PY3\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L737
 [PY3\_PROGRAM\_BIN]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L914
 [PYTEST\_BIN]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L445
 [PY\_ANY\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L544
 [RECURSIVE\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2121
 [RESOURCES\_LIBRARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2021
 [R\_MODULE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2234
 [SO\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2293
 [TS\_TEST\_HERMIONE\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L92
 [TS\_TEST\_JEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L29
 [TS\_TEST\_PLAYWRIGHT\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L125
 [TS\_TEST\_PLAYWRIGHT\_LARGE\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L155
 [TS\_TEST\_VITEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L61
 [UNION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2524
 [UNITTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1373
 [UNITTEST\_FOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1855
 [UNITTEST\_WITH\_CUSTOM\_ENTRY\_POINT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1409
 [YQL\_PYTHON3\_UDF]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L305
 [YQL\_PYTHON3\_UDF\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L356
 [YQL\_PYTHON\_UDF]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L248
 [YQL\_PYTHON\_UDF\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L277
 [YQL\_PYTHON\_UDF\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L342
 [YQL\_UDF\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L129
 [YQL\_UDF\_MODULE\_CONTRIB]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L141
 [YQL\_UDF\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L43
 [YQL\_UDF\_YDB\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L135
 [YT\_UNITTEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1399
 [Y\_BENCHMARK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1793
 [ACCELEO]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L5
 [ADDINCL]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [ADDINCLSELF]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3136
 [ADD\_CHECK]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19325788#L771
 [ADD\_CHECK\_PY\_IMPORTS]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19325788#L61
 [ADD\_CLANG\_TIDY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1173
 [ADD\_COMPILABLE\_TRANSLATE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2731
 [ADD\_COMPILABLE\_TRANSLIT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2741
 [ADD\_DLLS\_TO\_JAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2077
 [ADD\_IWYU]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1177
 [ADD\_PYTEST\_BIN]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19325788#L61
 [ADD\_YTEST]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19325788#L1559
 [ALICE\_GENERATE\_FUNCTION\_PROTO\_INCLUDES]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/alice.py?rev=19325788#L85
 [ALICE\_GENERATE\_FUNCTION\_SPECS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/alice.py?rev=19325788#L46
 [ALLOCATOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2629
 [ALLOCATOR\_IMPL]: https://github.com/yandex/yatool/tree/main/build/conf/opensource.conf?rev=19325788#L113
 [ALL\_PYTEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1168
 [ALL\_PY\_EXTRA\_LINT\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1188
 [ALL\_PY\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1150
 [ALL\_RESOURCE\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2820
 [ALL\_RESOURCE\_FILES\_FROM\_DIRS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2835
 [ALL\_SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2411
 [ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2011
 [ARCHIVE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4120
 [ARCHIVE\_ASM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4098
 [ARCHIVE\_BY\_KEYS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4131
 [AR\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3374
 [ASM\_PREINCLUDE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5197
 [ASSERT]: https://github.com/yandex/yatool/tree/main/build/plugins/macros_with_error.py?rev=19325788#L28
 [AUTO\_SERVICE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L92
 [BENCHMARK\_OPTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1830
 [BISON\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L57
 [BISON\_GEN\_C]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L64
 [BISON\_GEN\_CPP]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L72
 [BISON\_HEADER]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L94
 [BISON\_NO\_HEADER]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L104
 [BPF]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4966
 [BPF\_STATIC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4980
 [BUILDWITH\_CYTHON\_C]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4004
 [BUILDWITH\_CYTHON\_CPP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3973
 [BUILDWITH\_RAGEL6]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4042
 [BUILD\_CATBOOST]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/other.conf?rev=19325788#L9
 [BUILD\_ONLY\_IF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [BUILD\_YDL\_DESC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3710
 [BUNDLE]: https://github.com/yandex/yatool/tree/main/build/plugins/bundle.py?rev=19325788#L4
 [BUNDLE\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2860
 [CFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4238
 [CGO\_CFLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L443
 [CGO\_LDFLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L452
 [CGO\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L426
 [CHECK\_ALLOWED\_PATH]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/container_layers.py?rev=19325788#L4
 [CHECK\_CONTRIB\_CREDITS]: https://github.com/yandex/yatool/tree/main/build/plugins/credits.py?rev=19325788#L9
 [CHECK\_DEPENDENT\_DIRS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L483
 [CHECK\_JAVA\_DEPS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1773
 [CLANG\_EMIT\_AST\_CXX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4929
 [CLANG\_EMIT\_AST\_CXX\_RUN\_TOOL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5742
 [CLANG\_WARNINGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5711
 [CLEAN\_TEXTREL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2154
 [CMAKE\_EXPORTED\_TARGET\_NAME]: https://github.com/yandex/yatool/tree/main/build/conf/opensource.conf?rev=19325788#L108
 [COLLECT\_CONFIG\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5552
 [COLLECT\_FRONTEND\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5538
 [COLLECT\_GO\_SWAGGER\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L5
 [COLLECT\_JINJA\_TEMPLATES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5431
 [COLLECT\_YAML\_CONFIG\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5545
 [COMPILE\_C\_AS\_CXX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4887
 [COMPILE\_LUA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3633
 [COMPILE\_LUA\_21]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3652
 [COMPILE\_LUA\_OPENRESTY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3670
 [CONFIGURE\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4217
 [CONFTEST\_LOAD\_POLICY\_LEGACY\_GLOBAL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1694
 [CONFTEST\_LOAD\_POLICY\_LOCAL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1682
 [CONLYFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4261
 [COPY]: https://github.com/yandex/yatool/tree/main/build/plugins/cp.py?rev=19325788#L6
 [COPY\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2776
 [COPY\_FILE\_WITH\_CONTEXT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2796
 [COW]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L884
 [CPP\_ADDINCL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5289
 [CPP\_ENUMS\_SERIALIZATION]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19325788#L815
 [CPP\_EVLOG]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L605
 [CPP\_EV\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L283
 [CPP\_PROTOLIBS\_DEBUG\_INFO]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L74
 [CPP\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L273
 [CPP\_PROTO\_PLUGIN0]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L259
 [CPP\_PROTO\_PLUGIN2]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L294
 [CREATE\_BUILDINFO\_FOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4187
 [CREATE\_INIT\_PY\_STRUCTURE]: https://github.com/yandex/yatool/tree/main/build/plugins/create_init_py.py?rev=19325788#L4
 [CREDITS\_DISCLAIMER]: https://github.com/yandex/yatool/tree/main/build/plugins/credits.py?rev=19325788#L4
 [CTEMPLATE\_VARNAMES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4903
 [CUDA\_NVCC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/cuda.conf?rev=19325788#L39
 [CUDA\_SRCS]: https://github.com/yandex/yatool/tree/main/build/plugins/cuda.py?rev=19325788#L13
 [CUSTOM\_LINK\_STEP\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1332
 [CXXFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4268
 [CYTHON\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4275
 [DARWIN\_SIGNED\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5481
 [DARWIN\_STRINGS\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5477
 [DATA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1594
 [DATA\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1620
 [DEB\_VERSION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4514
 [DECIMAL\_MD5\_LOWER\_32\_BITS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4200
 [DECLARE\_EXTERNAL\_HOST\_RESOURCES\_BUNDLE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [DECLARE\_EXTERNAL\_HOST\_RESOURCES\_BUNDLE\_BY\_JSON]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [DECLARE\_EXTERNAL\_HOST\_RESOURCES\_PACK]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [DECLARE\_EXTERNAL\_RESOURCE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [DECLARE\_EXTERNAL\_RESOURCE\_BY\_JSON]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [DECLARE\_IN\_DIRS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4708
 [DEFAULT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [DEFAULT\_JAVA\_SRCS\_LAYOUT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L524
 [DEFAULT\_JDK\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2397
 [DEFAULT\_JUNIT\_JAVA\_SRCS\_LAYOUT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L542
 [DEPENDENCY\_MANAGEMENT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2106
 [DEPENDS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [DIRECT\_DEPS\_ONLY]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2275
 [DISABLE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [DISABLE\_DATA\_VALIDATION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1578
 [DLL\_FOR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [DOCKER\_IMAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1610
 [DOCS\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L332
 [DOCS\_COPY\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L13
 [DOCS\_DIR]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L288
 [DOCS\_HTML\_FROM]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L254
 [DOCS\_INCLUDE\_SOURCES]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L356
 [DOCS\_VARS]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L344
 [DYNAMIC\_LIBRARY\_FROM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2251
 [ELSE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [ELSEIF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [EMBED\_JAVA\_VCS\_INFO]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L413
 [ENABLE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [ENABLE\_PREVIEW]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1975
 [END]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [ENDIF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [ENV]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1663
 [EVLOG\_CMD]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L1071
 [EXCLUDE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2019
 [EXCLUDE\_TAGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [EXPERIMENTAL\_FORK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2965
 [EXPLICIT\_DATA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1630
 [EXPLICIT\_OUTPUTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5108
 [EXPORTS\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1296
 [EXPORT\_ALL\_DYNAMIC\_SYMBOLS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1314
 [EXTERNAL\_RESOURCE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [EXTRADIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [EXTRALIBS\_STATIC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2724
 [FBS\_CMD]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19325788#L153
 [FBS\_NAMESPACE]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19325788#L95
 [FBS\_TO\_PY2SRC]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19325788#L28
 [FILES]: https://github.com/yandex/yatool/tree/main/build/plugins/files.py?rev=19325788#L1
 [FLATC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19325788#L10
 [FLAT\_JOIN\_SRCS\_GLOBAL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3007
 [FLEX\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L50
 [FLEX\_GEN\_C]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L80
 [FLEX\_GEN\_CPP]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L87
 [FORK\_SUBTESTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2927
 [FORK\_TESTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2913
 [FORK\_TEST\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2953
 [FROM\_ARCHIVE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4872
 [FROM\_SANDBOX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4852
 [FULL\_JAVA\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L512
 [FUNCTION\_ORDERING\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L151
 [FUZZ\_DICTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1530
 [FUZZ\_OPTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1549
 [GENERATE\_ENUM\_SERIALIZATION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4493
 [GENERATE\_ENUM\_SERIALIZATION\_WITH\_HEADER]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4505
 [GENERATE\_IMPLIB]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5797
 [GENERATE\_PY\_PROTOS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L671
 [GENERATE\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/plugins/java.py?rev=19325788#L288
 [GENERATE\_YT\_RECORD]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yt.conf?rev=19325788#L7
 [GEN\_SCHEEME2]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4600
 [GLOBAL\_CFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4246
 [GLOBAL\_SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2393
 [GOLANG\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L187
 [GO\_ASM\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L149
 [GO\_BENCH\_TIMEOUT]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1110
 [GO\_CGO1\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L157
 [GO\_CGO2\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L165
 [GO\_COMPILE\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L173
 [GO\_EMBED\_BINDIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L558
 [GO\_EMBED\_DIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L525
 [GO\_EMBED\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L489
 [GO\_EMBED\_TEST\_DIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L533
 [GO\_EMBED\_XTEST\_DIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L541
 [GO\_GRPC\_GATEWAY\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L640
 [GO\_GRPC\_GATEWAY\_SWAGGER\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L648
 [GO\_GRPC\_GATEWAY\_V2\_OPENAPI\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L700
 [GO\_GRPC\_GATEWAY\_V2\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L718
 [GO\_LDFLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L435
 [GO\_LINK\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L181
 [GO\_MOCKGEN\_CONTRIB\_FROM]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1187
 [GO\_MOCKGEN\_FROM]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1177
 [GO\_MOCKGEN\_MOCKS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1238
 [GO\_MOCKGEN\_PACKAGE]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1203
 [GO\_MOCKGEN\_REFLECT]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1212
 [GO\_MOCKGEN\_SOURCE]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1267
 [GO\_MOCKGEN\_TYPES]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1193
 [GO\_OAPI\_CODEGEN]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1283
 [GO\_OAPI\_CODEGEN\_TAXI]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1306
 [GO\_OAPI\_CODEGEN\_TAXI\_1134]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1312
 [GO\_OAPI\_CODEGEN\_V2]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L1300
 [GO\_PACKAGE\_NAME]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L384
 [GO\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L412
 [GO\_PROTO\_USE\_V2]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L648
 [GO\_SKIP\_TESTS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L463
 [GO\_SSO]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L219
 [GO\_SSO\_TOOL]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L232
 [GO\_TEST\_EMBED\_BINDIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L566
 [GO\_TEST\_EMBED\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L497
 [GO\_TEST\_FOR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [GO\_TEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L402
 [GO\_XTEST\_EMBED\_BINDIR]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L574
 [GO\_XTEST\_EMBED\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L505
 [GO\_XTEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/go.conf?rev=19325788#L412
 [GRPC]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L620
 [GRPC\_WITH\_GMOCK]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L641
 [HEADERS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5721
 [IDEA\_EXCLUDE\_DIRS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1932
 [IDEA\_MODULE\_NAME]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1952
 [IDEA\_RESOURCE\_DIRS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1942
 [IF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [INCLUDE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [INCLUDE\_ONCE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [INCLUDE\_TAGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [INDUCED\_DEPS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [INJECT\_PEERS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/node_modules.conf?rev=19325788#L86
 [IOS\_APP\_ASSETS\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5473
 [IOS\_APP\_COMMON\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5467
 [IOS\_APP\_SETTINGS]: https://github.com/yandex/yatool/tree/main/build/plugins/ios_app_settings.py?rev=19325788#L5
 [IOS\_ASSETS]: https://github.com/yandex/yatool/tree/main/build/plugins/ios_assets.py?rev=19325788#L6
 [IWYU\_MAPPING\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4459
 [JAR\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L599
 [JAR\_EXCLUDE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2326
 [JAR\_MAIN\_CLASS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1102
 [JAR\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L693
 [JAVAC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1963
 [JAVA\_DEPENDENCIES\_CONFIGURATION]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2315
 [JAVA\_EXTERNAL\_DEPENDENCIES]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2284
 [JAVA\_IGNORE\_CLASSPATH\_CLASH\_FOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L571
 [JAVA\_MODULE]: https://github.com/yandex/yatool/tree/main/build/plugins/java.py?rev=19325788#L41
 [JAVA\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L217
 [JAVA\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L996
 [JAVA\_RESOURCE\_TAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2068
 [JAVA\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2056
 [JAVA\_TEST]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19325788#L61
 [JAVA\_TEST\_DEPS]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19325788#L61
 [JDK\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2389
 [JNI\_EXPORTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1300
 [JOIN\_SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2986
 [JOIN\_SRCS\_GLOBAL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2997
 [JUNIT\_TESTS\_JAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L152
 [JVM\_ARGS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1762
 [KAPT\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L819
 [KAPT\_ANNOTATION\_PROCESSOR\_CLASSPATH]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L827
 [KAPT\_ANNOTATION\_PROCESSOR\_OPTIONS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L837
 [KAPT\_OPTS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L811
 [KOTLINC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2161
 [KTLINT\_BASELINE\_FILE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2424
 [KTLINT\_RULESET]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2432
 [LARGE\_FILES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4863
 [LDFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4228
 [LD\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3383
 [LICENSE]: https://github.com/yandex/yatool/tree/main/build/conf/license.conf?rev=19325788#L26
 [LICENSE\_RESTRICTION]: https://github.com/yandex/yatool/tree/main/build/conf/license.conf?rev=19325788#L43
 [LICENSE\_RESTRICTION\_EXCEPTIONS]: https://github.com/yandex/yatool/tree/main/build/conf/license.conf?rev=19325788#L66
 [LICENSE\_TEXTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5649
 [LINKER\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/plugins/linker_script.py?rev=19325788#L1
 [LINK\_EXCLUDE\_LIBRARIES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5781
 [LINT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1745
 [LIST\_PROTO]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L699
 [LJ\_21\_ARCHIVE]: https://github.com/yandex/yatool/tree/main/build/plugins/lj_archive.py?rev=19325788#L25
 [LJ\_ARCHIVE]: https://github.com/yandex/yatool/tree/main/build/plugins/lj_archive.py?rev=19325788#L1
 [LLVM\_BC]: https://github.com/yandex/yatool/tree/main/build/plugins/llvm_bc.py?rev=19325788#L4
 [LLVM\_COMPILE\_C]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4952
 [LLVM\_COMPILE\_CXX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4938
 [LLVM\_COMPILE\_LL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4989
 [LLVM\_LINK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4999
 [LLVM\_LLC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5020
 [LLVM\_OPT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5009
 [LOCAL\_JAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L703
 [LOCAL\_SOURCES\_JAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L708
 [MACROS\_WITH\_ERROR]: https://github.com/yandex/yatool/tree/main/build/plugins/macros_with_error.py?rev=19325788#L8
 [MANUAL\_GENERATION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3350
 [MASMFLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4253
 [MAVEN\_GROUP\_ID]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2000
 [MESSAGE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [MODULEWISE\_LICENSE\_RESTRICTION]: https://github.com/yandex/yatool/tree/main/build/conf/license.conf?rev=19325788#L58
 [NEED\_CHECK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4523
 [NEED\_REVIEW]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4541
 [NGINX\_MODULES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5626
 [NO\_BUILD\_IF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [NO\_CHECK\_IMPORTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5117
 [NO\_CLANG\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4431
 [NO\_CLANG\_MCDC\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4439
 [NO\_CLANG\_TIDY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4451
 [NO\_COMPILER\_WARNINGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4304
 [NO\_COW]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L888
 [NO\_CPU\_CHECK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3129
 [NO\_CUDA\_NVPRUNE]: https://github.com/yandex/yatool/tree/main/build/conf/cuda.conf?rev=19325788#L152
 [NO\_CYTHON\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1093
 [NO\_DEBUG\_INFO]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4894
 [NO\_DOCTESTS]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L420
 [NO\_EXPORT\_DYNAMIC\_SYMBOLS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1307
 [NO\_EXTENDED\_SOURCE\_SEARCH]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L335
 [NO\_IMPORT\_TRACING]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1084
 [NO\_IWYU]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4466
 [NO\_JOIN\_SRC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4403
 [NO\_LIBC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4357
 [NO\_LINT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1738
 [NO\_LTO]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L398
 [NO\_MYPY]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L510
 [NO\_NEED\_CHECK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4532
 [NO\_OPTIMIZE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4295
 [NO\_OPTIMIZE\_PY\_PROTOS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L164
 [NO\_PLATFORM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4368
 [NO\_PROFILE\_RUNTIME]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4447
 [NO\_PYTHON\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1076
 [NO\_RUNTIME]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4346
 [NO\_SANITIZE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4411
 [NO\_SANITIZE\_COVERAGE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4423
 [NO\_SPLIT\_DWARF]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2709
 [NO\_SSE4]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3121
 [NO\_TS\_TYPECHECK]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L294
 [NO\_UTIL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4335
 [NO\_WSHADOW]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4311
 [NO\_YMAKE\_PYTHON3]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L269
 [NVCC\_DEVICE\_LINK]: https://github.com/yandex/yatool/tree/main/build/conf/cuda.conf?rev=19325788#L143
 [OBJC\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4282
 [ONLY\_TAGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [OPENSOURCE\_EXPORT\_REPLACEMENT]: https://github.com/yandex/yatool/tree/main/build/conf/opensource.conf?rev=19325788#L83
 [OPENSOURCE\_EXPORT\_REPLACEMENT\_BY\_OS]: https://github.com/yandex/yatool/tree/main/build/conf/opensource.conf?rev=19325788#L92
 [ORIGINAL\_SOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5636
 [PACK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2437
 [PARALLEL\_TESTS\_WITHIN\_NODE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2896
 [PARTITIONED\_RECURSE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [PARTITIONED\_RECURSE\_FOR\_TESTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [PARTITIONED\_RECURSE\_ROOT\_RELATIVE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [PEERDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [PIRE\_INLINE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4109
 [PIRE\_INLINE\_CMD]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4104
 [POPULATE\_CPP\_COVERAGE\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/conf/coverage_full_instrumentation.conf?rev=19325788#L7
 [POPULATE\_CPP\_YNDEXING]: https://github.com/yandex/yatool/tree/main/build/conf/yndexing/cpp_instrumentation.conf?rev=19325788#L6
 [PREPARE\_INDUCED\_DEPS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4634
 [PROCESSOR\_CLASSES]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L88
 [PROCESS\_DOCS]: https://github.com/yandex/yatool/tree/main/build/plugins/docs.py?rev=19325788#L39
 [PROCESS\_MKDOCS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/mkdocs.py?rev=19325788#L35
 [PROTO2FBS]: https://github.com/yandex/yatool/tree/main/build/conf/fbs.conf?rev=19325788#L162
 [PROTOC\_FATAL\_WARNINGS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L144
 [PROTO\_ADDINCL]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L117
 [PROTO\_CMD]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L1076
 [PROTO\_NAMESPACE]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L134
 [PROTO\_TO\_NAMESPACE]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sdc_proto.py?rev=19325788#L11
 [PROVIDES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [PYTHON2\_ADDINCL]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L943
 [PYTHON2\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L631
 [PYTHON3\_ADDINCL]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L992
 [PYTHON3\_MODULE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L643
 [PYTHON\_PATH]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1718
 [PY\_CONSTRUCTOR]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19325788#L783
 [PY\_DOCTESTS]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19325788#L697
 [PY\_ENUMS\_SERIALIZATION]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19325788#L798
 [PY\_EXTRALIBS]: https://github.com/yandex/yatool/tree/main/build/plugins/extralibs.py?rev=19325788#L1
 [PY\_EXTRA\_LINT\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1198
 [PY\_MAIN]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19325788#L761
 [PY\_NAMESPACE]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L679
 [PY\_PROTOS\_FOR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [PY\_PROTO\_PLUGIN]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L189
 [PY\_PROTO\_PLUGIN2]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L201
 [PY\_REGISTER]: https://github.com/yandex/yatool/tree/main/build/plugins/pybuild.py?rev=19325788#L715
 [PY\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1124
 [RECURSE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [RECURSE\_FOR\_TESTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [RECURSE\_ROOT\_RELATIVE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [REGISTER\_SANDBOX\_IMPORT]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sandbox_registry.py?rev=19325788#L6
 [REGISTER\_YQL\_PYTHON\_UDF]: https://github.com/yandex/yatool/tree/main/build/plugins/yql_python_udf.py?rev=19325788#L11
 [REQUIREMENTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1653
 [REQUIRES]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L461
 [REQUIRE\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1605
 [RESOLVE\_PROTO]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L661
 [RESOURCE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L520
 [RESOURCE\_FILES]: https://github.com/yandex/yatool/tree/main/build/plugins/res.py?rev=19325788#L12
 [RESTRICT\_PATH]: https://github.com/yandex/yatool/tree/main/build/plugins/macros_with_error.py?rev=19325788#L13
 [RISK\_GEN\_DATA\_MODEL]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/fintech_risk_model.py?rev=19325788#L276
 [ROS\_SRCS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/ros.py?rev=19325788#L5
 [RUN]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19325788#L990
 [RUN\_ANTLR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5204
 [RUN\_ANTLR4]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5224
 [RUN\_ANTLR4\_CPP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5248
 [RUN\_ANTLR4\_CPP\_SPLIT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5238
 [RUN\_ANTLR4\_GO]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5258
 [RUN\_ANTLR4\_PYTHON2]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5271
 [RUN\_ANTLR4\_PYTHON3]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5284
 [RUN\_JAVASCRIPT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19325788#L260
 [RUN\_JAVASCRIPT\_AFTER\_BUILD]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19325788#L245
 [RUN\_JAVA\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L591
 [RUN\_LUA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4764
 [RUN\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4738
 [RUN\_PY3\_PROGRAM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4818
 [RUN\_PYTHON3]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4790
 [SDBUS\_CPP\_ADAPTOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5605
 [SDBUS\_CPP\_PROXY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5611
 [SDC\_DIAGS\_SPLIT\_GENERATOR\_V3]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sdc_diagnostics.py?rev=19325788#L59
 [SDC\_DIAGS\_SPLIT\_GENERATOR\_V4]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sdc_diagnostics.py?rev=19325788#L23
 [SDC\_INSTALL]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/sdc.py?rev=19325788#L59
 [SELECT\_CLANG\_SA\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L167
 [SELECT\_PROTO\_LAYOUT]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L82
 [SET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [SETUP\_EXECTEST]: https://github.com/yandex/yatool/tree/main/build/plugins/_dart_fields.py?rev=19325788#L61
 [SETUP\_PYTEST\_BIN]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19325788#L983
 [SETUP\_RUN\_PYTHON]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19325788#L1035
 [SET\_APPEND]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [SET\_APPEND\_WITH\_GLOBAL]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [SET\_COMPILE\_OUTPUTS\_MODIFIERS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3149
 [SET\_CPP\_COVERAGE\_FLAGS]: https://github.com/yandex/yatool/tree/main/build/plugins/coverage.py?rev=19325788#L42
 [SET\_RESOURCE\_MAP\_FROM\_JSON]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [SET\_RESOURCE\_URI\_FROM\_JSON]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [SIZE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2977
 [SKIP\_TEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1727
 [SOURCE\_GROUP]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [SPLIT\_CODEGEN]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/split_codegen.py?rev=19325788#L9
 [SPLIT\_DWARF]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2701
 [SPLIT\_FACTOR]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2941
 [SRC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3736
 [SRCDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/yndex/builtin.cpp?rev=19325788#L16
 [SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3755
 [SRC\_C\_AMX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3890
 [SRC\_C\_AVX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3866
 [SRC\_C\_AVX2]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3874
 [SRC\_C\_AVX512]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3882
 [SRC\_C\_NO\_LTO]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3964
 [SRC\_C\_PIC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3956
 [SRC\_C\_SSE2]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3826
 [SRC\_C\_SSE3]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3834
 [SRC\_C\_SSE4]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3850
 [SRC\_C\_SSE41]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3858
 [SRC\_C\_SSSE3]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3842
 [SRC\_C\_XOP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3899
 [SRC\_RESOURCE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L698
 [STRIP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4289
 [STYLE\_CPP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5697
 [STYLE\_DUMMY]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L376
 [STYLE\_FLAKE8]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L404
 [STYLE\_JSON]: https://github.com/yandex/yatool/tree/main/build/conf/custom_lint.conf?rev=19325788#L13
 [STYLE\_PY2\_FLAKE8]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L412
 [STYLE\_PYTHON]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L384
 [STYLE\_RUFF]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L395
 [STYLE\_YAML]: https://github.com/yandex/yatool/tree/main/build/conf/custom_lint.conf?rev=19325788#L23
 [STYLE\_YQL]: https://github.com/yandex/yatool/tree/main/build/conf/custom_lint.conf?rev=19325788#L33
 [SUBSCRIBER]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4555
 [SUPPRESSIONS]: https://github.com/yandex/yatool/tree/main/build/plugins/suppressions.py?rev=19325788#L1
 [SYMLINK]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4606
 [SYSTEM\_PROPERTIES]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1750
 [TAG]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1642
 [TASKLET]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5303
 [TASKLET\_REG]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5320
 [TASKLET\_REG\_EXT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5335
 [TEST\_CWD]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2581
 [TEST\_DATA]: https://github.com/yandex/yatool/tree/main/build/plugins/ytest.py?rev=19325788#L118
 [TEST\_JAVA\_CLASSPATH\_CMD\_TYPE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2298
 [TEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1574
 [THINLTO\_CACHE]: https://github.com/yandex/yatool/tree/main/build/conf/linkers/ld.conf?rev=19325788#L434
 [TIMEOUT]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2869
 [TOOLCHAIN]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5755
 [TS\_BIOME]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L364
 [TS\_BUILD\_ENV]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19325788#L269
 [TS\_BUILD\_OUTPUTS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_library.conf?rev=19325788#L56
 [TS\_BUILD\_SCRIPT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_library.conf?rev=19325788#L52
 [TS\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19325788#L35
 [TS\_ESLINT\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19325788#L139
 [TS\_EXCLUDE\_FILES\_GLOB]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19325788#L97
 [TS\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19325788#L212
 [TS\_FILES\_GLOB]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19325788#L221
 [TS\_LARGE\_FILES]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts.conf?rev=19325788#L235
 [TS\_LINT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_check.conf?rev=19325788#L8
 [TS\_NEXT\_BUILD\_OPTIONS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19325788#L22
 [TS\_NEXT\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19325788#L11
 [TS\_NEXT\_EXPERIMENTAL\_BUILD\_MODE]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19325788#L45
 [TS\_NEXT\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_next.conf?rev=19325788#L35
 [TS\_PROTO\_OPT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_proto.conf?rev=19325788#L88
 [TS\_PROTO\_PACKAGE\_NAME]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_proto.conf?rev=19325788#L103
 [TS\_RSPACK\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_rspack.conf?rev=19325788#L10
 [TS\_RSPACK\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_rspack.conf?rev=19325788#L22
 [TS\_STYLELINT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L338
 [TS\_TEST]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_check.conf?rev=19325788#L12
 [TS\_TEST\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L228
 [TS\_TEST\_DATA]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L269
 [TS\_TEST\_DEPENDS\_ON\_BUILD]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L278
 [TS\_TEST\_INCLUDE\_NODEJS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L285
 [TS\_TEST\_SRCS]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L246
 [TS\_TYPECHECK]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_test.conf?rev=19325788#L315
 [TS\_VITE\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_vite.conf?rev=19325788#L10
 [TS\_VITE\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_vite.conf?rev=19325788#L24
 [TS\_WEBPACK\_CONFIG]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_webpack.conf?rev=19325788#L10
 [TS\_WEBPACK\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_webpack.conf?rev=19325788#L22
 [UBERJAR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1808
 [UBERJAR\_APPENDING\_TRANSFORMER]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1908
 [UBERJAR\_HIDE\_EXCLUDE\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1837
 [UBERJAR\_HIDE\_INCLUDE\_PATTERN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1852
 [UBERJAR\_HIDING\_PREFIX]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1822
 [UBERJAR\_MANIFEST\_TRANSFORMER\_ATTRIBUTE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1892
 [UBERJAR\_MANIFEST\_TRANSFORMER\_MAIN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1879
 [UBERJAR\_PATH\_EXCLUDE\_PREFIX]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1866
 [UBERJAR\_SERVICES\_RESOURCE\_TRANSFORMER]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1921
 [UDF\_NO\_PROBE]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L26
 [UDF\_NO\_SCAN]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L33
 [UPDATE\_VCS\_JAVA\_INFO\_NODEP]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4160
 [USE\_ANNOTATION\_PROCESSOR]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L620
 [USE\_COMMON\_GOOGLE\_APIS]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L363
 [USE\_CXX]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4378
 [USE\_DYNAMIC\_CUDA]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1322
 [USE\_ERROR\_PRONE]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L1782
 [USE\_JAVALITE]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L537
 [USE\_KTLINT\_OLD]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2414
 [USE\_LEGACY\_PNPM\_VIRTUAL\_STORE]: https://github.com/yandex/yatool/tree/main/build/conf/ts/node_modules.conf?rev=19325788#L82
 [USE\_LINKER\_GOLD]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L871
 [USE\_LLVM\_BC16]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4910
 [USE\_LLVM\_BC18]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4915
 [USE\_LLVM\_BC20]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4920
 [USE\_MODERN\_FLEX]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L112
 [USE\_MODERN\_FLEX\_WITH\_HEADER]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L123
 [USE\_NASM]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4395
 [USE\_OLD\_FLEX]: https://github.com/yandex/yatool/tree/main/build/conf/bison_lex.conf?rev=19325788#L132
 [USE\_PLANTUML]: https://github.com/yandex/yatool/tree/main/build/conf/docs.conf?rev=19325788#L275
 [USE\_PYTHON2]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1045
 [USE\_PYTHON3]: https://github.com/yandex/yatool/tree/main/build/conf/python.conf?rev=19325788#L1062
 [USE\_RECIPE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1706
 [USE\_SA\_PLUGINS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L176
 [USE\_SKIFF]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L305
 [USE\_UTIL]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4386
 [USRV\_GEN\_GRPC\_CLIENT\_V2]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19325788#L338
 [USRV\_GEN\_GRPC\_CLIENT\_V2\_STRUCTS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19325788#L342
 [USRV\_GEN\_GRPC\_SERVICE\_V2]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19325788#L346
 [USRV\_GEN\_GRPC\_SERVICE\_V2\_STRUCTS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19325788#L350
 [USRV\_GEN\_PROTO\_STRUCTS]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/userver.py?rev=19325788#L319
 [VALIDATE\_DATA\_RESTART]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L2879
 [VALIDATE\_IN\_DIRS]: https://github.com/yandex/yatool/tree/main/build/plugins/macros_with_error.py?rev=19325788#L35
 [VCS\_INFO\_FILE]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4174
 [VERSION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L4563
 [VISIBILITY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5583
 [VITE\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_vite.conf?rev=19325788#L30
 [WEBPACK\_OUTPUT]: https://github.com/yandex/yatool/tree/main/build/conf/ts/ts_webpack.conf?rev=19325788#L28
 [WINDOWS\_LONG\_PATH\_MANIFEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5568
 [WINDOWS\_MANIFEST]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5563
 [WITHOUT\_LICENSE\_TEXTS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5657
 [WITHOUT\_VERSION]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5759
 [WITH\_DYNAMIC\_LIBS]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1064
 [WITH\_JDK]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2116
 [WITH\_KAPT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2147
 [WITH\_KOTLIN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2135
 [WITH\_KOTLINC\_ALLOPEN]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2179
 [WITH\_KOTLINC\_DETEKT]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2225
 [WITH\_KOTLINC\_LOMBOK]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2190
 [WITH\_KOTLINC\_NOARG]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2202
 [WITH\_KOTLINC\_SERIALIZATION]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2214
 [WITH\_KOTLIN\_GRPC]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L231
 [WITH\_NODE\_MODULES]: https://github.com/yandex/yatool/tree/main/build/conf/ts/node_modules.conf?rev=19325788#L27
 [WITH\_YA\_1931]: https://github.com/yandex/yatool/tree/main/build/conf/java.conf?rev=19325788#L2442
 [YABS\_GENERATE\_CONF]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/yabs_generate_conf.py?rev=19325788#L10
 [YABS\_GENERATE\_PHANTOM\_CONF\_PATCH]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/yabs_generate_conf.py?rev=19325788#L41
 [YABS\_GENERATE\_PHANTOM\_CONF\_TEST\_CHECK]: https://github.com/yandex/yatool/tree/main/build/internal/plugins/yabs_generate_conf.py?rev=19325788#L51
 [YA\_CONF\_JSON]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L5678
 [YDL\_DESC\_USE\_BINARY]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L3727
 [YQL\_ABI\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L228
 [YQL\_LAST\_ABI\_VERSION]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yql_udf.conf?rev=19325788#L237
 [YT\_ORM\_PROTO\_YSON]: https://github.com/yandex/yatool/tree/main/build/conf/proto.conf?rev=19325788#L446
 [YT\_RECORD\_DISABLE\_PEERDIR]: https://github.com/yandex/yatool/tree/main/build/conf/project_specific/yt.conf?rev=19325788#L3
 [YT\_SPEC]: https://github.com/yandex/yatool/tree/main/build/ymake.core.conf?rev=19325788#L1563
 [ALIASES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L31
 [ALLOWED]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L34
 [ALLOWED\_IN\_LINTERS\_MAKE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L35
 [ARGS\_PARSER]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L43
 [CMD]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L44
 [DEFAULT\_NAME\_GENERATOR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L45
 [EPILOGUE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L46
 [EXTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L47
 [FILE\_GROUP]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L91
 [FINAL\_TARGET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L50
 [GEN\_FROM\_FILE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L53
 [GLOBAL]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L56
 [GLOBAL\_CMD]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L57
 [GLOBAL\_EXTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L60
 [GLOBAL\_SEM]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L61
 [IGNORED]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L64
 [INCLUDE\_TAG]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L67
 [NODE\_TYPE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L70
 [NO\_EXPAND]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L73
 [PEERDIRSELF]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L80
 [PEERDIR\_POLICY]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L77
 [PROXY]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L81
 [RESTRICTED]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L87
 [SEM]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L88
 [SYMLINK\_POLICY]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L89
 [TRANSITION]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L94
 [USE\_PEERS\_LATE\_OUTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L90
 [VERSION\_PROXY]: https://github.com/yandex/yatool/tree/main/devtools/ymake/lang/properties.h?rev=19325788#L84
 [APPLIED\_EXCLUDES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L23
 [ARCADIA\_BUILD\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L24
 [ARCADIA\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L25
 [AUTO\_INPUT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L26
 [BINDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L27
 [CMAKE\_CURRENT\_BINARY\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L29
 [CMAKE\_CURRENT\_SOURCE\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L30
 [CONSUME\_NON\_MANAGEABLE\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L31
 [CURDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L32
 [DART\_CLASSPATH]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L34
 [DART\_CLASSPATH\_DEPS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L33
 [DEFAULT\_MODULE\_LICENSE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L35
 [DEPENDENCY\_MANAGEMENT\_VALUE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L36
 [DONT\_RESOLVE\_INCLUDES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L37
 [DYNAMIC\_LINK]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L38
 [EV\_HEADER\_EXTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L39
 [EXCLUDE\_SUBMODULES]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L40
 [EXCLUDE\_VALUE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L41
 [EXPORTED\_BUILD\_SYSTEM\_BUILD\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L42
 [EXPORTED\_BUILD\_SYSTEM\_SOURCE\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L43
 [GLOBAL\_SUFFIX]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L45
 [GLOBAL\_TARGET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L46
 [GO\_TEST\_FOR\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L48
 [HAS\_MANAGEABLE\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L49
 [IGNORE\_JAVA\_DEPENDENCIES\_CONFIGURATION]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L50
 [INPUT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L51
 [JAVA\_DEPENDENCIES\_CONFIGURATION\_VALUE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L53
 [MANAGED\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L55
 [MANAGED\_PEERS\_CLOSURE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L54
 [MANGLED\_MODULE\_TYPE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L56
 [MODDIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L57
 [MODULE\_ARGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L58
 [MODULE\_COMMON\_CONFIGS\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L59
 [MODULE\_KIND]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L60
 [MODULE\_LANG]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L61
 [MODULE\_PREFIX]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L62
 [MODULE\_SEM\_IGNORE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L68
 [MODULE\_SUFFIX]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L63
 [MODULE\_TYPE]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L67
 [NON\_NAMAGEABLE\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L70
 [OUTPUT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L71
 [PASS\_PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L74
 [PEERDIR\_TAGS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L75
 [PEERS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L77
 [PEERS\_LATE\_OUTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L76
 [PROTO\_HEADER\_EXTS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L78
 [PYTHON\_BIN]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L79
 [REALPRJNAME]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L80
 [SONAME]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L81
 [SRCS\_GLOBAL]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L83
 [START\_TARGET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L84
 [TARGET]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L85
 [TEST\_CASE\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L86
 [TEST\_OUT\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L87
 [TEST\_SOURCE\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L88
 [TEST\_WORK\_ROOT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L89
 [TOOLS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L90
 [TS\_CONFIG\_DECLARATION]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L92
 [TS\_CONFIG\_DECLARATION\_MAP]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L91
 [TS\_CONFIG\_DEDUCE\_OUT]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L93
 [TS\_CONFIG\_OUT\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L94
 [TS\_CONFIG\_PRESERVE\_JSX]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L95
 [TS\_CONFIG\_ROOT\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L96
 [TS\_CONFIG\_SOURCE\_MAP]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L97
 [UNITTEST\_DIR]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L98
 [UNITTEST\_MOD]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L99
 [USE\_ALL\_SRCS]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L100
 [USE\_GLOBAL\_CMD]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L101
 [YMAKE\_BIN]: https://github.com/yandex/yatool/tree/main/devtools/ymake/vardefs.h?rev=19325788#L102
