...
Y_FORCE_INLINE void TNodeAddCtx::AddDepIface(EDepType depType, EMakeNodeType elemNodeType, TElemId elemId) {
...
Y_FORCE_INLINE TAddDepAdaptor& TNodeAddCtx::AddOutput(TFileElemId elemId, EMakeNodeType defaultType, bool addToOwn) {
