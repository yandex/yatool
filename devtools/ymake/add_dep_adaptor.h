...
public:
    ...
    virtual void AddDepIface(EDepType /* depType */, EMakeNodeType /* elemNodeType */, TElemId /* elemId */) = 0;
    virtual void AddDeps(const TDeps& /* deps */) = 0;
    virtual bool AddUniqueDep(EDepType /* depType */, EMakeNodeType /* elemNodeType */, TElemId /* elemId */) = 0;
    ...
    virtual void AddDirsToProps(const TVector<TFileElemId>& /* dirIds */, TStringBuf /* propName */) = 0;
    virtual void AddDirsToProps(const TPropsNodeList& /* props */, TStringBuf /* propName */) = 0;
    virtual TAddDepAdaptor& AddOutput(TFileElemId /* fileId */, EMakeNodeType /* defaultType */, bool addToOwn = true) = 0;
