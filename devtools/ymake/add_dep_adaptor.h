...
public:
    ...
    virtual void AddDepIface(EDepType /* depType */, EMakeNodeType /* elemNodeType */, ui32 /* elemId */) = 0;
    virtual void AddDeps(const TDeps& /* deps */) = 0;
    virtual bool AddUniqueDep(EDepType /* depType */, EMakeNodeType /* elemNodeType */, ui32 /* elemId */) = 0;
    ...
    virtual TAddDepAdaptor& AddOutput(ui32 /* fileId */, EMakeNodeType /* defaultType */, bool addToOwn = true) = 0;
