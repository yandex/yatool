...
VARIABLE(GLOB_VAR_ELEM_IDS, "Space separated glob variable name ElemIDs")
...
VARIABLE(JAVA_DEPENDENCY_VIEW, "Active Java dependency view: COMPILE or RUNTIME")
VARIABLE(JAVA_IMPL_PEERS, "Internal list of direct Java implementation dependency directories")
...
VARIABLE(_TEST_HELPER__NOINLINE__, "")
