...
RUN = 'RUN_JAVA_PROGRAM'
RUN_MANAGED = 'RUN_JAVA_PROGRAM_MANAGED'
R_IN = 'IN'
R_IN_DIR = 'IN_DIR'
R_OUT = 'OUT'
R_OUT_DIR = 'OUT_DIR'
R_CLASSPATH = 'CLASSPATH'
R_ADD_SRCS = 'ADD_SRCS_TO_CLASSPATH'
R_CP_USE_COMMAND_FILE = 'CP_USE_COMMAND_FILE'
R_CWD = 'CWD'
