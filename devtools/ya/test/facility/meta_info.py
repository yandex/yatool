...
class DartInfo(MetaInfo):
    def __init__(self, dart_info):
        ...
        self._java_classpath_cmd_type = dart_info.get(jbuild.gen.consts.T_JAVA_CLASSPATH_CMD_TYPE)
        ...
        self._t_system_properties = dart_info.get(jbuild.gen.consts.T_SYSTEM_PROPERTIES)
