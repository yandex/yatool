...
class GradleOptions(core.yarg.Options):
    ...
    def consumer():
        return [
            ...
            core.yarg.ArgConsumer(
                [GradleOptions.OPT_ERRORPRONE],
                help='Enable errorprone in Gradle project',
                hook=core.yarg.SetConstValueHook('errorprone', True),
                group=GradleOptions.YGRADLE_OPT_GROUP,
            ),
            core.yarg.ArgConsumer(
