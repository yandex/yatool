...
def disambiguate_targets(
    ...
    raise AssertionError(
        f"[{target}] Can't choose between {' and '.join(m.__name__ for m in styler_classes)}. "
        "It's either lack of disambiguation rules or the function is called with styler classes "
        "of different StylerKinds. Neither should happen."
    )
