...
class JavaSpecificOptions(Options):
    ...
    def consumer():
        return [
            ...
            ArgConsumer(
                ['--maven-export'],
                help='Build JARs and POMs for Maven export; add --deploy to publish',
            ...
            ArgConsumer(
                ...
                help='Compatibility option; no effect on Maven export',
            ...
            ArgConsumer(
                ['--deploy'],
                help='Publish Maven artifacts (requires --maven-export and repository id/url)',
            ...
            ArgConsumer(
                ['--repository-id'],
                help="Repository id for --deploy (server id in settings.xml)",
            ...
            ArgConsumer(
                ['--repository-url'],
                help="Repository URL for --deploy",
            ...
            ArgConsumer(
                ['--settings'],
                help="Maven settings.xml for --deploy (passed as both -s and -gs)",
            ...
            ArgConsumer(
                ['--maven-out-dir'],
                help="Set build/outputDirectory in generated POMs; use -o for ya build results",
