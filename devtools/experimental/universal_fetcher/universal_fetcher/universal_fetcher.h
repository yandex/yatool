...
namespace NUniversalFetcher {
    ...
    public:
        TResultPtr Download(const TString& uri, const TDstPath& dstPath) noexcept;
        TResultPtr DownloadToDir(const TString& uri, const TString& dstDir) noexcept;
        TResultPtr DownloadToFile(const TString& uri, const TString& dstFile) noexcept;
